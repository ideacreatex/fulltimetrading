...
Для дальнейшего paper-forward наблюдения выбран профиль `advance-touch-alpaca-20260716`:
...
- профиль остаётся `paper_forward_candidate`, `production_approved=false`; отправка entry-заявок принудительно выключена.
...
| **Финальный cap .44 / target 2.70** | **+116.12%** | **+14.97%** | **−19.24%** | **72** | **2.53** | **Выбран для paper-forward** |
...
Профиль предназначен только для paper-forward сигналов и наблюдения. Live и автоматическая отправка entry-заявок не включены.
