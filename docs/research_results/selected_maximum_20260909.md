...
Full machine-readable metrics: [selected_maximum_20260909.json](selected_maximum_20260909.json). Frozen recipes, hashes, curves and every replay are in `var/reports/selected_maximum_20260909/`.
