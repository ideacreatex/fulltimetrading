...
Снимок: 2026-09-22 11:13:29 Нью-Йорк
У брокера: позиций 1, открытых заявок 1.
Капитал $27,572.88; деньги на счёте $26,583.66.
Лимит покупок брокера $54,156.54: может включать заёмные средства, это не бюджет новой сделки.
...
- Generated: `2026-09-22T15:13:29+00:00`
- Market open: `yes`
- Orders enabled: `yes`
...
## Positions
- `MSFT` qty `2`, avg `$492.00`, price `$494.82`, value `$989.64`, P/L `$5.64` (`+0.57%`), today `-1.35%`

## Open Orders
- `MSFT` sell stop qty `2`, limit `-`, status `new`

## Recent Actions
- `2026-09-22T15:13:05` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T15:12:02` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T15:11:00` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T15:09:58` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T15:08:55` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T15:07:53` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T15:06:51` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T15:05:48` `-` `monitor_heartbeat`: details_redacted_use_local_logs
