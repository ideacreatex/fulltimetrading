...
Снимок: 2026-09-23 07:56:49 Нью-Йорк
У брокера: позиций 1, открытых заявок 1.
Капитал $27,587.50; деньги на счёте $26,583.66.
Лимит покупок брокера $54,171.16: может включать заёмные средства, это не бюджет новой сделки.
...
- Generated: `2026-09-23T11:56:49+00:00`
- Market open: `no`
- Orders enabled: `yes`
...
## Positions
- `MSFT` qty `2`, avg `$492.00`, price `$501.92`, value `$1003.84`, P/L `$19.84` (`+2.02%`), today `+0.79%`

## Open Orders
- `MSFT` sell stop qty `2`, limit `-`, status `new`

## Recent Actions
- `2026-09-23T11:55:45` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T11:54:43` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T11:53:41` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T11:52:39` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T11:51:36` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T11:50:34` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T11:49:32` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T11:48:30` `-` `monitor_heartbeat`: details_redacted_use_local_logs
