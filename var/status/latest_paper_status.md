...
Снимок: 2026-09-17 19:04:23 Нью-Йорк
У брокера: позиций 1, открытых заявок 1.
Капитал $27,575.36; деньги на счёте $26,583.66.
Лимит покупок брокера $54,159.02: может включать заёмные средства, это не бюджет новой сделки.
...
- Generated: `2026-09-17T23:04:23+00:00`
- Market open: `no`
- Orders enabled: `yes`
...
## Positions
- `MSFT` qty `2`, avg `$492.00`, price `$495.85`, value `$991.70`, P/L `$7.70` (`+0.78%`), today `+1.13%`

## Open Orders
- `MSFT` sell stop qty `2`, limit `-`, status `accepted`

## Recent Actions
- `2026-09-17T23:04:16` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-17T23:03:14` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-17T23:02:11` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-17T23:01:09` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-17T23:00:07` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-17T22:59:05` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-17T22:58:03` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-17T22:57:00` `-` `monitor_heartbeat`: details_redacted_use_local_logs
