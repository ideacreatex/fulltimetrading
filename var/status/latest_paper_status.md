...
Снимок: 2026-09-24 19:00:07 Нью-Йорк
У брокера: позиций 1, открытых заявок 1.
Капитал $27,576.86; деньги на счёте $26,583.66.
Лимит покупок брокера $54,160.52: может включать заёмные средства, это не бюджет новой сделки.
...
- Generated: `2026-09-24T23:00:07+00:00`
- Market open: `no`
- Orders enabled: `yes`
...
## Positions
- `MSFT` qty `2`, avg `$492.00`, price `$496.60`, value `$993.20`, P/L `$9.20` (`+0.94%`), today `-0.80%`

## Open Orders
- `MSFT` sell stop qty `2`, limit `-`, status `new`

## Recent Actions
- `2026-09-24T22:59:45` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-24T22:58:43` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-24T22:57:41` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-24T22:56:39` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-24T22:55:36` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-24T22:54:34` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-24T22:53:32` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-24T22:52:30` `-` `monitor_heartbeat`: details_redacted_use_local_logs
