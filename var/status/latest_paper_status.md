...
Снимок: 2026-09-22 18:32:14 Нью-Йорк
У брокера: позиций 1, открытых заявок 1.
Капитал $27,583.36; деньги на счёте $26,583.66.
Лимит покупок брокера $54,167.02: может включать заёмные средства, это не бюджет новой сделки.
...
- Generated: `2026-09-22T22:32:14+00:00`
- Market open: `no`
- Orders enabled: `yes`
...
## Positions
- `MSFT` qty `2`, avg `$492.00`, price `$499.85`, value `$999.70`, P/L `$15.70` (`+1.60%`), today `-0.35%`

## Open Orders
- `MSFT` sell stop qty `2`, limit `-`, status `new`

## Recent Actions
- `2026-09-22T22:32:06` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T22:31:04` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T22:30:02` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T22:28:59` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T22:27:57` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T22:26:55` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T22:25:53` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T22:24:50` `-` `monitor_heartbeat`: details_redacted_use_local_logs
