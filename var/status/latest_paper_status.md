...
Снимок: 2026-09-21 04:43:30 Нью-Йорк
У брокера: позиций 1, открытых заявок 1.
Капитал $27,572.12; деньги на счёте $26,583.66.
Лимит покупок брокера $54,155.78: может включать заёмные средства, это не бюджет новой сделки.
...
- Generated: `2026-09-21T08:43:30+00:00`
- Market open: `no`
- Orders enabled: `yes`
...
## Positions
- `MSFT` qty `2`, avg `$492.00`, price `$494.23`, value `$988.46`, P/L `$4.46` (`+0.45%`), today `+0.09%`

## Open Orders
- `MSFT` sell stop qty `2`, limit `-`, status `new`

## Recent Actions
- `2026-09-21T08:42:52` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T08:41:50` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T08:40:48` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T08:39:46` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T08:38:44` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T08:37:41` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T08:36:39` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T08:35:37` `-` `monitor_heartbeat`: details_redacted_use_local_logs
