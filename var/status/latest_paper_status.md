...
Снимок: 2026-09-21 20:21:13 Нью-Йорк
У брокера: позиций 1, открытых заявок 1.
Капитал $27,586.60; деньги на счёте $26,583.66.
Лимит покупок брокера $54,170.26: может включать заёмные средства, это не бюджет новой сделки.
...
- Generated: `2026-09-22T00:21:13+00:00`
- Market open: `no`
- Orders enabled: `yes`
...
## Positions
- `MSFT` qty `2`, avg `$492.00`, price `$501.47`, value `$1002.94`, P/L `$18.94` (`+1.93%`), today `+1.56%`

## Open Orders
- `MSFT` sell stop qty `2`, limit `-`, status `accepted`

## Recent Actions
- `2026-09-22T00:21:10` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T00:20:08` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T00:19:06` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T00:18:04` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T00:17:02` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T00:15:59` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T00:14:57` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T00:13:55` `-` `monitor_heartbeat`: details_redacted_use_local_logs
