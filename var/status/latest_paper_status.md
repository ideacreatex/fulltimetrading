...
Снимок: 2026-09-16 09:34:18 Нью-Йорк
У брокера: позиций 1, открытых заявок 1.
Капитал $27,572.48; деньги на счёте $26,583.66.
Лимит покупок брокера $54,156.14: может включать заёмные средства, это не бюджет новой сделки.
...
- Generated: `2026-09-16T13:34:18+00:00`
- Market open: `yes`
- Orders enabled: `yes`
...
- Equity: `$27,572.48`
- Cash: `$26,583.66`
- Buying power: `$54,156.14`
- Hybrid-v4 runtime: `active`
- Hybrid-v4 health: `healthy`
- Telegram outbox: `0 pending, 0 failed pending, 104 delivered`
...
## Positions
- `MSFT` qty `2`, avg `$492.00`, price `$494.36`, value `$988.72`, P/L `$4.72` (`+0.48%`), today `-0.56%`

## Open Orders
- `MSFT` sell stop qty `2`, limit `-`, status `new`

## Recent Actions
- `2026-09-16T13:34:13` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-16T13:33:10` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-16T13:32:08` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-16T13:31:06` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-16T13:30:03` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-16T13:29:01` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-16T13:27:59` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-16T13:26:57` `-` `monitor_heartbeat`: details_redacted_use_local_logs
