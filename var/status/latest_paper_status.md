...
Снимок: 2026-09-22 21:48:50 Нью-Йорк
У брокера: позиций 1, открытых заявок 1.
Капитал $27,583.30; деньги на счёте $26,583.66.
Лимит покупок брокера $54,166.96: может включать заёмные средства, это не бюджет новой сделки.
...
- Generated: `2026-09-23T01:48:50+00:00`
- Market open: `no`
- Orders enabled: `yes`
...
## Positions
- `MSFT` qty `2`, avg `$492.00`, price `$499.82`, value `$999.64`, P/L `$15.64` (`+1.59%`), today `-0.36%`

## Open Orders
- `MSFT` sell stop qty `2`, limit `-`, status `new`

## Recent Actions
- `2026-09-23T01:48:12` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T01:47:10` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T01:46:08` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T01:45:05` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T01:44:03` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T01:43:01` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T01:41:59` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T01:40:56` `-` `monitor_heartbeat`: details_redacted_use_local_logs
