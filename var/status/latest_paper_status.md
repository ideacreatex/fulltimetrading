...
Снимок: 2026-09-17 20:50:14 Нью-Йорк
У брокера: позиций 1, открытых заявок 1.
Капитал $27,577.82; деньги на счёте $26,583.66.
Лимит покупок брокера $54,161.48: может включать заёмные средства, это не бюджет новой сделки.
...
- Generated: `2026-09-18T00:50:14+00:00`
- Market open: `no`
- Orders enabled: `yes`
...
- Telegram outbox: `0 pending, 0 failed pending, 111 delivered`
...
## Positions
- `MSFT` qty `2`, avg `$492.00`, price `$497.08`, value `$994.16`, P/L `$10.16` (`+1.03%`), today `+1.38%`

## Open Orders
- `MSFT` sell stop qty `2`, limit `-`, status `accepted`

## Recent Actions
- `2026-09-18T00:49:58` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-18T00:48:55` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-18T00:47:53` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-18T00:46:51` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-18T00:45:49` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-18T00:44:47` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-18T00:43:44` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-18T00:42:42` `-` `monitor_heartbeat`: details_redacted_use_local_logs
