...
Снимок: 2026-09-21 15:33:55 Нью-Йорк
У брокера: позиций 1, открытых заявок 1.
Капитал $27,584.60; деньги на счёте $26,583.66.
Лимит покупок брокера $54,168.26: может включать заёмные средства, это не бюджет новой сделки.
...
- Generated: `2026-09-21T19:33:55+00:00`
- Market open: `yes`
- Orders enabled: `yes`
...
## Positions
- `MSFT` qty `2`, avg `$492.00`, price `$500.47`, value `$1000.94`, P/L `$16.94` (`+1.72%`), today `+1.35%`

## Open Orders
- `MSFT` sell stop qty `2`, limit `-`, status `new`

## Recent Actions
- `2026-09-21T19:32:53` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T19:31:51` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T19:30:49` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T19:29:46` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T19:28:44` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T19:27:41` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T19:26:38` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T19:25:36` `-` `monitor_heartbeat`: details_redacted_use_local_logs
