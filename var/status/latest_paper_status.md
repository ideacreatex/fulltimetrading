...
Снимок: 2026-09-25 02:33:50 Нью-Йорк
У брокера: позиций 1, открытых заявок 1.
Капитал $27,579.26; деньги на счёте $26,583.66.
Лимит покупок брокера $54,162.92: может включать заёмные средства, это не бюджет новой сделки.
...
- Generated: `2026-09-25T06:33:50+00:00`
- Market open: `no`
- Orders enabled: `yes`
...
## Positions
- `MSFT` qty `2`, avg `$492.00`, price `$497.80`, value `$995.60`, P/L `$11.60` (`+1.18%`), today `-0.03%`

## Open Orders
- `MSFT` sell stop qty `2`, limit `-`, status `new`

## Recent Actions
- `2026-09-25T06:33:34` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T06:32:32` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T06:31:30` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T06:30:28` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T06:29:26` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T06:28:23` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T06:27:21` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T06:26:19` `-` `monitor_heartbeat`: details_redacted_use_local_logs
