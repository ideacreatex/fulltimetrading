...
Снимок: 2026-09-23 01:05:24 Нью-Йорк
У брокера: позиций 1, открытых заявок 1.
Капитал $27,584.38; деньги на счёте $26,583.66.
Лимит покупок брокера $54,168.04: может включать заёмные средства, это не бюджет новой сделки.
...
- Generated: `2026-09-23T05:05:24+00:00`
- Market open: `no`
- Orders enabled: `yes`
...
## Positions
- `MSFT` qty `2`, avg `$492.00`, price `$500.36`, value `$1000.72`, P/L `$16.72` (`+1.70%`), today `+0.47%`

## Open Orders
- `MSFT` sell stop qty `2`, limit `-`, status `new`

## Recent Actions
- `2026-09-23T05:05:10` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T05:04:08` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T05:03:06` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T05:02:04` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T05:01:02` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T04:59:59` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T04:58:57` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T04:57:55` `-` `monitor_heartbeat`: details_redacted_use_local_logs
