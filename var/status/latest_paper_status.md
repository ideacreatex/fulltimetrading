...
Снимок: 2026-09-24 06:53:40 Нью-Йорк
У брокера: позиций 1, открытых заявок 1.
Капитал $27,580.90; деньги на счёте $26,583.66.
Лимит покупок брокера $54,164.56: может включать заёмные средства, это не бюджет новой сделки.
...
- Generated: `2026-09-24T10:53:40+00:00`
- Market open: `no`
- Orders enabled: `yes`
...
## Positions
- `MSFT` qty `2`, avg `$492.00`, price `$498.62`, value `$997.24`, P/L `$13.24` (`+1.35%`), today `-0.39%`

## Open Orders
- `MSFT` sell stop qty `2`, limit `-`, status `new`

## Recent Actions
- `2026-09-24T10:53:35` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-24T10:52:33` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-24T10:51:30` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-24T10:50:28` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-24T10:49:26` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-24T10:48:24` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-24T10:47:21` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-24T10:46:19` `-` `monitor_heartbeat`: details_redacted_use_local_logs
