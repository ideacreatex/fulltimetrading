...
Снимок: 2026-09-22 04:25:07 Нью-Йорк
У брокера: позиций 1, открытых заявок 1.
Капитал $27,590.98; деньги на счёте $26,583.66.
Лимит покупок брокера $54,174.64: может включать заёмные средства, это не бюджет новой сделки.
...
- Generated: `2026-09-22T08:25:07+00:00`
- Market open: `no`
- Orders enabled: `yes`
...
## Positions
- `MSFT` qty `2`, avg `$492.00`, price `$503.66`, value `$1007.32`, P/L `$23.32` (`+2.37%`), today `+0.41%`

## Open Orders
- `MSFT` sell stop qty `2`, limit `-`, status `new`

## Recent Actions
- `2026-09-22T08:24:19` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T08:23:16` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T08:22:14` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T08:21:12` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T08:20:10` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T08:19:07` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T08:18:05` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T08:17:03` `-` `monitor_heartbeat`: details_redacted_use_local_logs
