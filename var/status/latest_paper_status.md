...
Снимок: 2026-09-16 13:21:14 Нью-Йорк
У брокера: позиций 1, открытых заявок 1.
Капитал $27,571.79; деньги на счёте $26,583.66.
Лимит покупок брокера $54,155.45: может включать заёмные средства, это не бюджет новой сделки.
...
- Generated: `2026-09-16T17:21:14+00:00`
- Market open: `yes`
- Orders enabled: `yes`
...
- Equity: `$27,571.79`
- Cash: `$26,583.66`
- Buying power: `$54,155.45`
- Hybrid-v4 runtime: `active`
- Hybrid-v4 health: `healthy`
- Telegram outbox: `0 pending, 0 failed pending, 105 delivered`
- Hybrid reconciliation: `reconciled`
- Hybrid entry/add now: `blocked`
- Hybrid entry/add reasons: `Отправка и исполнение проверяются отдельно от целей модели.`
- Telegram opening report key: `portfolio-open:d1d8ddc9925b:2026-09-16:v3`
- Telegram close report key: `portfolio-close:hybrid-v4-bull5-2026-09-15:2026-09-15`
- Live review not before: `2026-10-16T13:41:18+00:00`

## Positions
- `MSFT` qty `2`, avg `$492.00`, price `$494.06`, value `$988.13`, P/L `$4.13` (`+0.42%`), today `-0.61%`

## Open Orders
- `MSFT` sell stop qty `2`, limit `-`, status `new`

## Recent Actions
- `2026-09-16T17:20:34` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-16T17:19:32` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-16T17:18:30` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-16T17:17:27` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-16T17:16:25` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-16T17:15:22` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-16T17:14:20` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-16T17:13:18` `-` `monitor_heartbeat`: details_redacted_use_local_logs
