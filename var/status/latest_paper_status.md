...
Снимок: 2026-09-22 00:23:08 Нью-Йорк
У брокера: позиций 1, открытых заявок 1.
Капитал $27,586.18; деньги на счёте $26,583.66.
Лимит покупок брокера $54,169.84: может включать заёмные средства, это не бюджет новой сделки.
...
- Generated: `2026-09-22T04:23:08+00:00`
- Market open: `no`
- Orders enabled: `yes`
...
## Positions
- `MSFT` qty `2`, avg `$492.00`, price `$501.26`, value `$1002.52`, P/L `$18.52` (`+1.88%`), today `-0.07%`

## Open Orders
- `MSFT` sell stop qty `2`, limit `-`, status `accepted`

## Recent Actions
- `2026-09-22T04:22:39` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T04:21:37` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T04:20:34` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T04:19:32` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T04:18:30` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T04:17:28` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T04:16:26` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T04:15:24` `-` `monitor_heartbeat`: details_redacted_use_local_logs
