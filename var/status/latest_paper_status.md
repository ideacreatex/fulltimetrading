...
Снимок: 2026-09-21 17:34:55 Нью-Йорк
У брокера: позиций 1, открытых заявок 1.
Капитал $27,586.48; деньги на счёте $26,583.66.
Лимит покупок брокера $54,170.14: может включать заёмные средства, это не бюджет новой сделки.
...
- Generated: `2026-09-21T21:34:55+00:00`
- Market open: `no`
- Orders enabled: `yes`
...
## Positions
- `MSFT` qty `2`, avg `$492.00`, price `$501.41`, value `$1002.82`, P/L `$18.82` (`+1.91%`), today `+1.54%`

## Open Orders
- `MSFT` sell stop qty `2`, limit `-`, status `accepted`

## Recent Actions
- `2026-09-21T21:34:18` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T21:33:16` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T21:32:14` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T21:31:12` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T21:30:10` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T21:29:08` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T21:28:05` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T21:27:03` `-` `monitor_heartbeat`: details_redacted_use_local_logs
