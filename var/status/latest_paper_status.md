...
Снимок: 2026-09-23 06:10:57 Нью-Йорк
У брокера: позиций 1, открытых заявок 1.
Капитал $27,588.78; деньги на счёте $26,583.66.
Лимит покупок брокера $54,172.44: может включать заёмные средства, это не бюджет новой сделки.
...
- Generated: `2026-09-23T10:10:57+00:00`
- Market open: `no`
- Orders enabled: `yes`
...
## Positions
- `MSFT` qty `2`, avg `$492.00`, price `$502.56`, value `$1005.12`, P/L `$21.12` (`+2.15%`), today `+0.92%`

## Open Orders
- `MSFT` sell stop qty `2`, limit `-`, status `new`

## Recent Actions
- `2026-09-23T10:09:59` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T10:08:56` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T10:07:54` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T10:06:52` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T10:05:50` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T10:04:47` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T10:03:45` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T10:02:43` `-` `monitor_heartbeat`: details_redacted_use_local_logs
