...
Снимок: 2026-09-18 11:12:20 Нью-Йорк
У брокера: позиций 1, открытых заявок 1.
Капитал $27,570.50; деньги на счёте $26,583.66.
Лимит покупок брокера $54,154.16: может включать заёмные средства, это не бюджет новой сделки.
...
- Generated: `2026-09-18T15:12:20+00:00`
- Market open: `yes`
- Orders enabled: `yes`
...
## Positions
- `MSFT` qty `2`, avg `$492.00`, price `$493.38`, value `$986.75`, P/L `$2.75` (`+0.28%`), today `-0.88%`

## Open Orders
- `MSFT` sell stop qty `2`, limit `-`, status `new`

## Recent Actions
- `2026-09-18T15:11:25` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-18T15:10:23` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-18T15:09:20` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-18T15:08:18` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-18T15:07:16` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-18T15:06:13` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-18T15:05:11` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-18T15:04:09` `-` `monitor_heartbeat`: details_redacted_use_local_logs
