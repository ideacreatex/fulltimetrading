...
Снимок: 2026-09-25 11:53:28 Нью-Йорк
У брокера: позиций 1, открытых заявок 1.
Капитал $27,609.44; деньги на счёте $26,583.66.
Лимит покупок брокера $54,193.10: может включать заёмные средства, это не бюджет новой сделки.
...
- Generated: `2026-09-25T15:53:28+00:00`
- Market open: `yes`
- Orders enabled: `yes`
...
- Telegram outbox: `0 pending, 0 failed pending, 139 delivered`
...
## Positions
- `MSFT` qty `2`, avg `$492.00`, price `$512.89`, value `$1025.78`, P/L `$41.78` (`+4.25%`), today `+3.00%`

## Open Orders
- `MSFT` sell stop qty `2`, limit `-`, status `new`

## Recent Actions
- `2026-09-25T15:52:58` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T15:51:55` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T15:50:52` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T15:49:50` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T15:48:48` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T15:47:46` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T15:46:43` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T15:45:41` `-` `monitor_heartbeat`: details_redacted_use_local_logs
