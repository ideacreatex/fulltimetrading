...
Снимок: 2026-09-25 14:09:37 Нью-Йорк
У брокера: позиций 1, открытых заявок 1.
Капитал $27,618.81; деньги на счёте $26,583.66.
Лимит покупок брокера $54,202.47: может включать заёмные средства, это не бюджет новой сделки.
...
- Generated: `2026-09-25T18:09:37+00:00`
- Market open: `yes`
- Orders enabled: `yes`
...
## Positions
- `MSFT` qty `2`, avg `$492.00`, price `$517.58`, value `$1035.16`, P/L `$51.16` (`+5.20%`), today `+3.95%`

## Open Orders
- `MSFT` sell stop qty `2`, limit `-`, status `new`

## Recent Actions
- `2026-09-25T18:08:56` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T18:07:53` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T18:06:51` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T18:05:49` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T18:04:46` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T18:03:44` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T18:02:42` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T18:01:40` `-` `monitor_heartbeat`: details_redacted_use_local_logs
