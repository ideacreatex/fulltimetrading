...
Снимок: 2026-09-22 01:23:37 Нью-Йорк
У брокера: позиций 1, открытых заявок 1.
Капитал $27,590.70; деньги на счёте $26,583.66.
Лимит покупок брокера $54,174.36: может включать заёмные средства, это не бюджет новой сделки.
...
- Generated: `2026-09-22T05:23:37+00:00`
- Market open: `no`
- Orders enabled: `yes`
...
## Positions
- `MSFT` qty `2`, avg `$492.00`, price `$503.52`, value `$1007.04`, P/L `$23.04` (`+2.34%`), today `+0.38%`

## Open Orders
- `MSFT` sell stop qty `2`, limit `-`, status `accepted`

## Recent Actions
- `2026-09-22T05:22:47` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T05:21:44` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T05:20:42` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T05:19:40` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T05:18:38` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T05:17:36` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T05:16:33` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T05:15:31` `-` `monitor_heartbeat`: details_redacted_use_local_logs
