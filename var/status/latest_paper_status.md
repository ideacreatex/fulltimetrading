...
Снимок: 2026-09-25 10:07:34 Нью-Йорк
У брокера: позиций 1, открытых заявок 1.
Капитал $27,602.78; деньги на счёте $26,583.66.
Лимит покупок брокера $54,186.44: может включать заёмные средства, это не бюджет новой сделки.
...
- Generated: `2026-09-25T14:07:34+00:00`
- Market open: `yes`
- Orders enabled: `yes`
...
## Positions
- `MSFT` qty `2`, avg `$492.00`, price `$509.56`, value `$1019.12`, P/L `$35.12` (`+3.57%`), today `+2.34%`

## Open Orders
- `MSFT` sell stop qty `2`, limit `-`, status `new`

## Recent Actions
- `2026-09-25T14:07:05` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T14:06:03` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T14:05:01` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T14:03:58` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T14:02:56` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T14:01:54` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T14:00:52` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T13:59:50` `-` `monitor_heartbeat`: details_redacted_use_local_logs
