...
Снимок: 2026-09-18 07:25:28 Нью-Йорк
У брокера: позиций 1, открытых заявок 1.
Капитал $27,578.13; деньги на счёте $26,583.66.
Лимит покупок брокера $54,161.79: может включать заёмные средства, это не бюджет новой сделки.
...
- Generated: `2026-09-18T11:25:28+00:00`
- Market open: `no`
- Orders enabled: `yes`
...
## Positions
- `MSFT` qty `2`, avg `$492.00`, price `$497.23`, value `$994.47`, P/L `$10.47` (`+1.06%`), today `-0.10%`

## Open Orders
- `MSFT` sell stop qty `2`, limit `-`, status `new`

## Recent Actions
- `2026-09-18T11:25:06` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-18T11:24:04` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-18T11:23:02` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-18T11:21:59` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-18T11:20:57` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-18T11:19:55` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-18T11:18:52` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-18T11:17:50` `-` `monitor_heartbeat`: details_redacted_use_local_logs
