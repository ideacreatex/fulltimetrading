...
Снимок: 2026-09-25 05:05:04 Нью-Йорк
У брокера: позиций 1, открытых заявок 1.
Капитал $27,577.18; деньги на счёте $26,583.66.
Лимит покупок брокера $54,160.84: может включать заёмные средства, это не бюджет новой сделки.
...
- Generated: `2026-09-25T09:05:04+00:00`
- Market open: `no`
- Orders enabled: `yes`
...
## Positions
- `MSFT` qty `2`, avg `$492.00`, price `$496.76`, value `$993.52`, P/L `$9.52` (`+0.97%`), today `-0.24%`

## Open Orders
- `MSFT` sell stop qty `2`, limit `-`, status `new`

## Recent Actions
- `2026-09-25T09:05:02` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T09:04:00` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T09:02:58` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T09:01:56` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T09:00:53` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T08:59:50` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T08:58:48` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T08:57:46` `-` `monitor_heartbeat`: details_redacted_use_local_logs
