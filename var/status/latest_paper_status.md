...
Снимок: 2026-09-25 09:52:27 Нью-Йорк
У брокера: позиций 1, открытых заявок 1.
Капитал $27,615.38; деньги на счёте $26,583.66.
Лимит покупок брокера $54,199.04: может включать заёмные средства, это не бюджет новой сделки.
...
- Generated: `2026-09-25T13:52:27+00:00`
- Market open: `yes`
- Orders enabled: `yes`
...
## Positions
- `MSFT` qty `2`, avg `$492.00`, price `$515.93`, value `$1031.86`, P/L `$47.86` (`+4.86%`), today `+3.62%`

## Open Orders
- `MSFT` sell stop qty `2`, limit `-`, status `new`

## Recent Actions
- `2026-09-25T13:51:32` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T13:50:30` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T13:49:28` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T13:48:25` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T13:47:23` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T13:46:21` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T13:45:18` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T13:44:16` `-` `monitor_heartbeat`: details_redacted_use_local_logs
