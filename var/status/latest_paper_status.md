...
Снимок: 2026-09-17 11:00:25 Нью-Йорк
У брокера: позиций 1, открытых заявок 1.
Капитал $27,576.24; деньги на счёте $26,583.66.
Лимит покупок брокера $54,159.90: может включать заёмные средства, это не бюджет новой сделки.
...
- Generated: `2026-09-17T15:00:25+00:00`
- Market open: `yes`
- Orders enabled: `yes`
...
## Positions
- `MSFT` qty `2`, avg `$492.00`, price `$496.29`, value `$992.58`, P/L `$8.58` (`+0.87%`), today `+1.22%`

## Open Orders
- `MSFT` sell stop qty `2`, limit `-`, status `new`

## Recent Actions
- `2026-09-17T14:59:34` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-17T14:58:32` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-17T14:57:29` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-17T14:56:27` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-17T14:55:25` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-17T14:54:23` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-17T14:53:20` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-17T14:52:18` `-` `monitor_heartbeat`: details_redacted_use_local_logs
