...
Снимок: 2026-09-24 14:12:40 Нью-Йорк
У брокера: позиций 1, открытых заявок 1.
Капитал $27,574.92; деньги на счёте $26,583.66.
Лимит покупок брокера $54,158.58: может включать заёмные средства, это не бюджет новой сделки.
...
- Generated: `2026-09-24T18:12:40+00:00`
- Market open: `yes`
- Orders enabled: `yes`
...
## Positions
- `MSFT` qty `2`, avg `$492.00`, price `$495.63`, value `$991.26`, P/L `$7.26` (`+0.74%`), today `-0.99%`

## Open Orders
- `MSFT` sell stop qty `2`, limit `-`, status `new`

## Recent Actions
- `2026-09-24T18:11:54` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-24T18:10:52` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-24T18:09:50` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-24T18:08:47` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-24T18:07:44` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-24T18:06:40` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-24T18:05:38` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-24T18:04:36` `-` `monitor_heartbeat`: details_redacted_use_local_logs
