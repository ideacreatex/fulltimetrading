...
Снимок: 2026-09-23 06:56:19 Нью-Йорк
У брокера: позиций 1, открытых заявок 1.
Капитал $27,588.66; деньги на счёте $26,583.66.
Лимит покупок брокера $54,172.32: может включать заёмные средства, это не бюджет новой сделки.
...
- Generated: `2026-09-23T10:56:19+00:00`
- Market open: `no`
- Orders enabled: `yes`
...
## Positions
- `MSFT` qty `2`, avg `$492.00`, price `$502.50`, value `$1005.00`, P/L `$21.00` (`+2.13%`), today `+0.90%`

## Open Orders
- `MSFT` sell stop qty `2`, limit `-`, status `new`

## Recent Actions
- `2026-09-23T10:55:37` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T10:54:35` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T10:53:33` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T10:52:31` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T10:51:28` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T10:50:26` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T10:49:24` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T10:48:21` `-` `monitor_heartbeat`: details_redacted_use_local_logs
