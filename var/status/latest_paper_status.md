...
Снимок: 2026-09-22 00:53:22 Нью-Йорк
У брокера: позиций 1, открытых заявок 1.
Капитал $27,590.54; деньги на счёте $26,583.66.
Лимит покупок брокера $54,174.20: может включать заёмные средства, это не бюджет новой сделки.
...
- Generated: `2026-09-22T04:53:22+00:00`
- Market open: `no`
- Orders enabled: `yes`
...
## Positions
- `MSFT` qty `2`, avg `$492.00`, price `$503.44`, value `$1006.88`, P/L `$22.88` (`+2.33%`), today `+0.36%`

## Open Orders
- `MSFT` sell stop qty `2`, limit `-`, status `accepted`

## Recent Actions
- `2026-09-22T04:52:43` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T04:51:41` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T04:50:38` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T04:49:36` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T04:48:34` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T04:47:32` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T04:46:30` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T04:45:27` `-` `monitor_heartbeat`: details_redacted_use_local_logs
