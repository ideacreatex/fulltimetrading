...
Снимок: 2026-09-24 14:42:56 Нью-Йорк
У брокера: позиций 1, открытых заявок 1.
Капитал $27,576.94; деньги на счёте $26,583.66.
Лимит покупок брокера $54,160.60: может включать заёмные средства, это не бюджет новой сделки.
...
- Generated: `2026-09-24T18:42:56+00:00`
- Market open: `yes`
- Orders enabled: `yes`
...
## Positions
- `MSFT` qty `2`, avg `$492.00`, price `$496.72`, value `$993.44`, P/L `$9.44` (`+0.96%`), today `-0.77%`

## Open Orders
- `MSFT` sell stop qty `2`, limit `-`, status `new`

## Recent Actions
- `2026-09-24T18:42:04` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-24T18:41:02` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-24T18:40:00` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-24T18:38:57` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-24T18:37:55` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-24T18:36:52` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-24T18:35:50` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-24T18:34:48` `-` `monitor_heartbeat`: details_redacted_use_local_logs
