...
Снимок: 2026-09-25 05:35:19 Нью-Йорк
У брокера: позиций 1, открытых заявок 1.
Капитал $27,577.64; деньги на счёте $26,583.66.
Лимит покупок брокера $54,161.30: может включать заёмные средства, это не бюджет новой сделки.
...
- Generated: `2026-09-25T09:35:19+00:00`
- Market open: `no`
- Orders enabled: `yes`
...
## Positions
- `MSFT` qty `2`, avg `$492.00`, price `$496.99`, value `$993.98`, P/L `$9.98` (`+1.01%`), today `-0.19%`

## Open Orders
- `MSFT` sell stop qty `2`, limit `-`, status `new`

## Recent Actions
- `2026-09-25T09:35:07` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T09:34:04` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T09:33:02` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T09:32:00` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T09:30:58` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T09:29:56` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T09:28:53` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T09:27:51` `-` `monitor_heartbeat`: details_redacted_use_local_logs
