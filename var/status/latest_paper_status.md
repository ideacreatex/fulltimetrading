...
Снимок: 2026-09-25 06:50:56 Нью-Йорк
У брокера: позиций 1, открытых заявок 1.
Капитал $27,577.72; деньги на счёте $26,583.66.
Лимит покупок брокера $54,161.38: может включать заёмные средства, это не бюджет новой сделки.
...
- Generated: `2026-09-25T10:50:56+00:00`
- Market open: `no`
- Orders enabled: `yes`
...
## Positions
- `MSFT` qty `2`, avg `$492.00`, price `$497.03`, value `$994.06`, P/L `$10.06` (`+1.02%`), today `-0.18%`

## Open Orders
- `MSFT` sell stop qty `2`, limit `-`, status `new`

## Recent Actions
- `2026-09-25T10:50:53` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T10:49:51` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T10:48:48` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T10:47:46` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T10:46:44` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T10:45:42` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T10:44:40` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T10:43:37` `-` `monitor_heartbeat`: details_redacted_use_local_logs
