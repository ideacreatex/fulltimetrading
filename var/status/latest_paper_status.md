...
Снимок: 2026-09-18 02:53:12 Нью-Йорк
У брокера: позиций 1, открытых заявок 1.
Капитал $27,581.90; деньги на счёте $26,583.66.
Лимит покупок брокера $54,165.56: может включать заёмные средства, это не бюджет новой сделки.
...
- Generated: `2026-09-18T06:53:12+00:00`
- Market open: `no`
- Orders enabled: `yes`
...
## Positions
- `MSFT` qty `2`, avg `$492.00`, price `$499.12`, value `$998.24`, P/L `$14.24` (`+1.45%`), today `+0.27%`

## Open Orders
- `MSFT` sell stop qty `2`, limit `-`, status `accepted`

## Recent Actions
- `2026-09-18T06:52:24` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-18T06:51:22` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-18T06:50:19` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-18T06:49:17` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-18T06:48:15` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-18T06:47:13` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-18T06:46:10` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-18T06:45:08` `-` `monitor_heartbeat`: details_redacted_use_local_logs
