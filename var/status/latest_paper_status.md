...
Снимок: 2026-09-22 22:03:57 Нью-Йорк
У брокера: позиций 1, открытых заявок 1.
Капитал $27,583.46; деньги на счёте $26,583.66.
Лимит покупок брокера $54,167.12: может включать заёмные средства, это не бюджет новой сделки.
...
- Generated: `2026-09-23T02:03:57+00:00`
- Market open: `no`
- Orders enabled: `yes`
...
## Positions
- `MSFT` qty `2`, avg `$492.00`, price `$499.90`, value `$999.80`, P/L `$15.80` (`+1.61%`), today `+0.38%`

## Open Orders
- `MSFT` sell stop qty `2`, limit `-`, status `new`

## Recent Actions
- `2026-09-23T02:03:46` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T02:02:44` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T02:01:41` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T02:00:39` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T01:59:37` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T01:58:35` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T01:57:33` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T01:56:30` `-` `monitor_heartbeat`: details_redacted_use_local_logs
