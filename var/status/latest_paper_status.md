...
Снимок: 2026-09-21 07:29:51 Нью-Йорк
У брокера: позиций 1, открытых заявок 1.
Капитал $27,575.44; деньги на счёте $26,583.66.
Лимит покупок брокера $54,159.10: может включать заёмные средства, это не бюджет новой сделки.
...
- Generated: `2026-09-21T11:29:51+00:00`
- Market open: `no`
- Orders enabled: `yes`
...
## Positions
- `MSFT` qty `2`, avg `$492.00`, price `$495.89`, value `$991.78`, P/L `$7.78` (`+0.79%`), today `+0.43%`

## Open Orders
- `MSFT` sell stop qty `2`, limit `-`, status `new`

## Recent Actions
- `2026-09-21T11:28:47` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T11:27:45` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T11:26:43` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T11:25:41` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T11:24:39` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T11:23:36` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T11:22:34` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T11:21:32` `-` `monitor_heartbeat`: details_redacted_use_local_logs
