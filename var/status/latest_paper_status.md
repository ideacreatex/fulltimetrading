...
Снимок: 2026-09-24 19:15:14 Нью-Йорк
У брокера: позиций 1, открытых заявок 1.
Капитал $27,576.66; деньги на счёте $26,583.66.
Лимит покупок брокера $54,160.32: может включать заёмные средства, это не бюджет новой сделки.
...
- Generated: `2026-09-24T23:15:14+00:00`
- Market open: `no`
- Orders enabled: `yes`
...
## Positions
- `MSFT` qty `2`, avg `$492.00`, price `$496.50`, value `$993.00`, P/L `$9.00` (`+0.92%`), today `-0.82%`

## Open Orders
- `MSFT` sell stop qty `2`, limit `-`, status `new`

## Recent Actions
- `2026-09-24T23:14:15` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-24T23:13:13` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-24T23:12:10` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-24T23:11:08` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-24T23:10:06` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-24T23:09:04` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-24T23:08:02` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-24T23:07:00` `-` `monitor_heartbeat`: details_redacted_use_local_logs
