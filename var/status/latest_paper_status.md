...
Снимок: 2026-09-25 14:24:44 Нью-Йорк
У брокера: позиций 1, открытых заявок 1.
Капитал $27,621.18; деньги на счёте $26,583.66.
Лимит покупок брокера $54,204.84: может включать заёмные средства, это не бюджет новой сделки.
...
- Generated: `2026-09-25T18:24:44+00:00`
- Market open: `yes`
- Orders enabled: `yes`
...
## Positions
- `MSFT` qty `2`, avg `$492.00`, price `$518.78`, value `$1037.57`, P/L `$53.57` (`+5.44%`), today `+4.19%`

## Open Orders
- `MSFT` sell stop qty `2`, limit `-`, status `new`

## Recent Actions
- `2026-09-25T18:24:30` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T18:23:28` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T18:22:25` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T18:21:23` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T18:20:21` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T18:19:19` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T18:18:17` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T18:17:14` `-` `monitor_heartbeat`: details_redacted_use_local_logs
