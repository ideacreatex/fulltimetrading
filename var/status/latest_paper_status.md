...
Снимок: 2026-09-21 16:04:11 Нью-Йорк
У брокера: позиций 1, открытых заявок 1.
Капитал $27,586.88; деньги на счёте $26,583.66.
Лимит покупок брокера $54,170.54: может включать заёмные средства, это не бюджет новой сделки.
...
- Generated: `2026-09-21T20:04:11+00:00`
- Market open: `no`
- Orders enabled: `yes`
...
## Positions
- `MSFT` qty `2`, avg `$492.00`, price `$501.61`, value `$1003.22`, P/L `$19.22` (`+1.95%`), today `+1.59%`

## Open Orders
- `MSFT` sell stop qty `2`, limit `-`, status `new`

## Recent Actions
- `2026-09-21T20:04:05` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T20:03:03` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T20:02:00` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T20:00:58` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T19:59:56` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T19:58:54` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T19:57:51` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T19:56:49` `-` `monitor_heartbeat`: details_redacted_use_local_logs
