...
Снимок: 2026-09-24 07:08:47 Нью-Йорк
У брокера: позиций 1, открытых заявок 1.
Капитал $27,580.48; деньги на счёте $26,583.66.
Лимит покупок брокера $54,164.14: может включать заёмные средства, это не бюджет новой сделки.
...
- Generated: `2026-09-24T11:08:47+00:00`
- Market open: `no`
- Orders enabled: `yes`
...
## Positions
- `MSFT` qty `2`, avg `$492.00`, price `$498.41`, value `$996.82`, P/L `$12.82` (`+1.30%`), today `-0.43%`

## Open Orders
- `MSFT` sell stop qty `2`, limit `-`, status `new`

## Recent Actions
- `2026-09-24T11:08:07` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-24T11:07:05` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-24T11:06:02` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-24T11:05:00` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-24T11:03:58` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-24T11:02:56` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-24T11:01:53` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-24T11:00:51` `-` `monitor_heartbeat`: details_redacted_use_local_logs
