...
Снимок: 2026-09-22 02:39:13 Нью-Йорк
У брокера: позиций 1, открытых заявок 1.
Капитал $27,590.52; деньги на счёте $26,583.66.
Лимит покупок брокера $54,174.18: может включать заёмные средства, это не бюджет новой сделки.
...
- Generated: `2026-09-22T06:39:13+00:00`
- Market open: `no`
- Orders enabled: `yes`
...
## Positions
- `MSFT` qty `2`, avg `$492.00`, price `$503.43`, value `$1006.86`, P/L `$22.86` (`+2.32%`), today `+0.36%`

## Open Orders
- `MSFT` sell stop qty `2`, limit `-`, status `accepted`

## Recent Actions
- `2026-09-22T06:38:28` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T06:37:26` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T06:36:24` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T06:35:21` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T06:34:19` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T06:33:17` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T06:32:15` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T06:31:13` `-` `monitor_heartbeat`: details_redacted_use_local_logs
