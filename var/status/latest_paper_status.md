...
Снимок: 2026-09-24 15:43:28 Нью-Йорк
У брокера: позиций 1, открытых заявок 1.
Капитал $27,579.14; деньги на счёте $26,583.66.
Лимит покупок брокера $54,162.80: может включать заёмные средства, это не бюджет новой сделки.
...
- Generated: `2026-09-24T19:43:28+00:00`
- Market open: `yes`
- Orders enabled: `yes`
...
## Positions
- `MSFT` qty `2`, avg `$492.00`, price `$497.74`, value `$995.48`, P/L `$11.48` (`+1.17%`), today `-0.57%`

## Open Orders
- `MSFT` sell stop qty `2`, limit `-`, status `new`

## Recent Actions
- `2026-09-24T19:42:26` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-24T19:41:23` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-24T19:40:21` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-24T19:39:18` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-24T19:38:16` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-24T19:37:14` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-24T19:36:11` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-24T19:35:09` `-` `monitor_heartbeat`: details_redacted_use_local_logs
