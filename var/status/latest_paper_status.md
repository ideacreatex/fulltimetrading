...
Снимок: 2026-09-17 16:48:17 Нью-Йорк
У брокера: позиций 1, открытых заявок 1.
Капитал $27,576.80; деньги на счёте $26,583.66.
Лимит покупок брокера $54,160.46: может включать заёмные средства, это не бюджет новой сделки.
...
- Generated: `2026-09-17T20:48:17+00:00`
- Market open: `no`
- Orders enabled: `yes`
...
## Positions
- `MSFT` qty `2`, avg `$492.00`, price `$496.57`, value `$993.14`, P/L `$9.14` (`+0.93%`), today `+1.28%`

## Open Orders
- `MSFT` sell stop qty `2`, limit `-`, status `accepted`

## Recent Actions
- `2026-09-17T20:47:28` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-17T20:46:26` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-17T20:45:24` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-17T20:44:22` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-17T20:43:20` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-17T20:42:17` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-17T20:41:15` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-17T20:40:13` `-` `monitor_heartbeat`: details_redacted_use_local_logs
