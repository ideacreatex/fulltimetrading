...
Снимок: 2026-09-23 18:17:25 Нью-Йорк
У брокера: позиций 1, открытых заявок 1.
Капитал $27,584.56; деньги на счёте $26,583.66.
Лимит покупок брокера $54,168.22: может включать заёмные средства, это не бюджет новой сделки.
...
- Generated: `2026-09-23T22:17:25+00:00`
- Market open: `no`
- Orders enabled: `yes`
...
## Positions
- `MSFT` qty `2`, avg `$492.00`, price `$500.45`, value `$1000.90`, P/L `$16.90` (`+1.72%`), today `+0.49%`

## Open Orders
- `MSFT` sell stop qty `2`, limit `-`, status `new`

## Recent Actions
- `2026-09-23T22:16:32` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T22:15:30` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T22:14:28` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T22:13:26` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T22:12:24` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T22:11:21` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T22:10:19` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T22:09:17` `-` `monitor_heartbeat`: details_redacted_use_local_logs
