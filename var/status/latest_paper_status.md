...
Снимок: 2026-09-21 01:11:44 Нью-Йорк
У брокера: позиций 1, открытых заявок 1.
Капитал $27,572.84; деньги на счёте $26,583.66.
Лимит покупок брокера $54,156.50: может включать заёмные средства, это не бюджет новой сделки.
...
- Generated: `2026-09-21T05:11:44+00:00`
- Market open: `no`
- Orders enabled: `yes`
...
## Positions
- `MSFT` qty `2`, avg `$492.00`, price `$494.59`, value `$989.18`, P/L `$5.18` (`+0.53%`), today `+0.16%`

## Open Orders
- `MSFT` sell stop qty `2`, limit `-`, status `new`

## Recent Actions
- `2026-09-21T05:11:07` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T05:10:05` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T05:09:03` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T05:08:01` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T05:06:58` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T05:05:56` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T05:04:54` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T05:03:51` `-` `monitor_heartbeat`: details_redacted_use_local_logs
