...
Снимок: 2026-09-21 03:27:51 Нью-Йорк
У брокера: позиций 1, открытых заявок 1.
Капитал $27,572.28; деньги на счёте $26,583.66.
Лимит покупок брокера $54,155.94: может включать заёмные средства, это не бюджет новой сделки.
...
- Generated: `2026-09-21T07:27:51+00:00`
- Market open: `no`
- Orders enabled: `yes`
...
## Positions
- `MSFT` qty `2`, avg `$492.00`, price `$494.31`, value `$988.62`, P/L `$4.62` (`+0.47%`), today `+0.11%`

## Open Orders
- `MSFT` sell stop qty `2`, limit `-`, status `new`

## Recent Actions
- `2026-09-21T07:27:05` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T07:26:02` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T07:25:00` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T07:23:58` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T07:22:56` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T07:21:53` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T07:20:50` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T07:19:48` `-` `monitor_heartbeat`: details_redacted_use_local_logs
