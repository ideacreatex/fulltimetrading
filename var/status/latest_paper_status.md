...
Снимок: 2026-09-22 03:39:44 Нью-Йорк
У брокера: позиций 1, открытых заявок 1.
Капитал $27,590.46; деньги на счёте $26,583.66.
Лимит покупок брокера $54,174.12: может включать заёмные средства, это не бюджет новой сделки.
...
- Generated: `2026-09-22T07:39:44+00:00`
- Market open: `no`
- Orders enabled: `yes`
...
## Positions
- `MSFT` qty `2`, avg `$492.00`, price `$503.40`, value `$1006.80`, P/L `$22.80` (`+2.32%`), today `+0.36%`

## Open Orders
- `MSFT` sell stop qty `2`, limit `-`, status `accepted`

## Recent Actions
- `2026-09-22T07:39:41` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T07:38:39` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T07:37:36` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T07:36:34` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T07:35:32` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T07:34:29` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T07:33:27` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T07:32:25` `-` `monitor_heartbeat`: details_redacted_use_local_logs
