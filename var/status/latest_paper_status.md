...
Снимок: 2026-09-25 08:06:35 Нью-Йорк
У брокера: позиций 1, открытых заявок 1.
Капитал $27,577.75; деньги на счёте $26,583.66.
Лимит покупок брокера $54,161.41: может включать заёмные средства, это не бюджет новой сделки.
...
- Generated: `2026-09-25T12:06:35+00:00`
- Market open: `no`
- Orders enabled: `yes`
...
## Positions
- `MSFT` qty `2`, avg `$492.00`, price `$497.04`, value `$994.09`, P/L `$10.09` (`+1.03%`), today `-0.18%`

## Open Orders
- `MSFT` sell stop qty `2`, limit `-`, status `new`

## Recent Actions
- `2026-09-25T12:05:42` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T12:04:39` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T12:03:37` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T12:02:34` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T12:01:32` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T12:00:30` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T11:59:27` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T11:58:25` `-` `monitor_heartbeat`: details_redacted_use_local_logs
