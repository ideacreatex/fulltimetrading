...
Снимок: 2026-09-25 02:03:29 Нью-Йорк
У брокера: позиций 1, открытых заявок 1.
Капитал $27,578.52; деньги на счёте $26,583.66.
Лимит покупок брокера $54,162.18: может включать заёмные средства, это не бюджет новой сделки.
...
- Generated: `2026-09-25T06:03:29+00:00`
- Market open: `no`
- Orders enabled: `yes`
...
## Positions
- `MSFT` qty `2`, avg `$492.00`, price `$497.43`, value `$994.86`, P/L `$10.86` (`+1.10%`), today `-0.10%`

## Open Orders
- `MSFT` sell stop qty `2`, limit `-`, status `new`

## Recent Actions
- `2026-09-25T06:02:27` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T06:01:25` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T06:00:22` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T05:59:20` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T05:58:18` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T05:57:16` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T05:56:13` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T05:55:11` `-` `monitor_heartbeat`: details_redacted_use_local_logs
