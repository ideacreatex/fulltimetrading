...
Снимок: 2026-09-24 02:21:19 Нью-Йорк
У брокера: позиций 1, открытых заявок 1.
Капитал $27,579.92; деньги на счёте $26,583.66.
Лимит покупок брокера $54,163.58: может включать заёмные средства, это не бюджет новой сделки.
...
- Generated: `2026-09-24T06:21:19+00:00`
- Market open: `no`
- Orders enabled: `yes`
...
## Positions
- `MSFT` qty `2`, avg `$492.00`, price `$498.13`, value `$996.26`, P/L `$12.26` (`+1.25%`), today `-0.49%`

## Open Orders
- `MSFT` sell stop qty `2`, limit `-`, status `new`

## Recent Actions
- `2026-09-24T06:20:30` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-24T06:19:27` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-24T06:18:25` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-24T06:17:23` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-24T06:16:21` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-24T06:15:18` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-24T06:14:16` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-24T06:13:14` `-` `monitor_heartbeat`: details_redacted_use_local_logs
