...
Снимок: 2026-09-25 07:06:04 Нью-Йорк
У брокера: позиций 1, открытых заявок 1.
Капитал $27,578.39; деньги на счёте $26,583.66.
Лимит покупок брокера $54,162.05: может включать заёмные средства, это не бюджет новой сделки.
...
- Generated: `2026-09-25T11:06:04+00:00`
- Market open: `no`
- Orders enabled: `yes`
...
## Positions
- `MSFT` qty `2`, avg `$492.00`, price `$497.36`, value `$994.73`, P/L `$10.73` (`+1.09%`), today `-0.11%`

## Open Orders
- `MSFT` sell stop qty `2`, limit `-`, status `new`

## Recent Actions
- `2026-09-25T11:05:24` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T11:04:22` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T11:03:20` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T11:02:17` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T11:01:15` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T11:00:13` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T10:59:10` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T10:58:08` `-` `monitor_heartbeat`: details_redacted_use_local_logs
