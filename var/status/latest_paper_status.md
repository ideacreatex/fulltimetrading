...
Снимок: 2026-09-25 05:20:12 Нью-Йорк
У брокера: позиций 1, открытых заявок 1.
Капитал $27,577.66; деньги на счёте $26,583.66.
Лимит покупок брокера $54,161.32: может включать заёмные средства, это не бюджет новой сделки.
...
- Generated: `2026-09-25T09:20:12+00:00`
- Market open: `no`
- Orders enabled: `yes`
...
## Positions
- `MSFT` qty `2`, avg `$492.00`, price `$497.00`, value `$994.00`, P/L `$10.00` (`+1.02%`), today `-0.19%`

## Open Orders
- `MSFT` sell stop qty `2`, limit `-`, status `new`

## Recent Actions
- `2026-09-25T09:19:33` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T09:18:31` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T09:17:29` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T09:16:26` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T09:15:24` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T09:14:22` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T09:13:20` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T09:12:17` `-` `monitor_heartbeat`: details_redacted_use_local_logs
