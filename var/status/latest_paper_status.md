...
Снимок: 2026-09-23 17:47:11 Нью-Йорк
У брокера: позиций 1, открытых заявок 1.
Капитал $27,583.66; деньги на счёте $26,583.66.
Лимит покупок брокера $54,167.32: может включать заёмные средства, это не бюджет новой сделки.
...
- Generated: `2026-09-23T21:47:11+00:00`
- Market open: `no`
- Orders enabled: `yes`
...
## Positions
- `MSFT` qty `2`, avg `$492.00`, price `$500.00`, value `$1000.00`, P/L `$16.00` (`+1.63%`), today `+0.40%`

## Open Orders
- `MSFT` sell stop qty `2`, limit `-`, status `new`

## Recent Actions
- `2026-09-23T21:46:30` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T21:45:28` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T21:44:26` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T21:43:24` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T21:42:22` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T21:41:19` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T21:40:17` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T21:39:15` `-` `monitor_heartbeat`: details_redacted_use_local_logs
