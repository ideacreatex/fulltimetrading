...
Снимок: 2026-09-17 15:32:40 Нью-Йорк
У брокера: позиций 1, открытых заявок 1.
Капитал $27,575.72; деньги на счёте $26,583.66.
Лимит покупок брокера $54,159.38: может включать заёмные средства, это не бюджет новой сделки.
...
- Generated: `2026-09-17T19:32:40+00:00`
- Market open: `yes`
- Orders enabled: `yes`
...
## Positions
- `MSFT` qty `2`, avg `$492.00`, price `$496.03`, value `$992.06`, P/L `$8.06` (`+0.82%`), today `+1.17%`

## Open Orders
- `MSFT` sell stop qty `2`, limit `-`, status `new`

## Recent Actions
- `2026-09-17T19:31:40` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-17T19:30:38` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-17T19:29:36` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-17T19:28:33` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-17T19:27:31` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-17T19:26:29` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-17T19:25:27` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-17T19:24:25` `-` `monitor_heartbeat`: details_redacted_use_local_logs
