...
Снимок: 2026-09-22 20:48:22 Нью-Йорк
У брокера: позиций 1, открытых заявок 1.
Капитал $27,582.48; деньги на счёте $26,583.66.
Лимит покупок брокера $54,166.14: может включать заёмные средства, это не бюджет новой сделки.
...
- Generated: `2026-09-23T00:48:22+00:00`
- Market open: `no`
- Orders enabled: `yes`
...
## Positions
- `MSFT` qty `2`, avg `$492.00`, price `$499.41`, value `$998.82`, P/L `$14.82` (`+1.51%`), today `-0.44%`

## Open Orders
- `MSFT` sell stop qty `2`, limit `-`, status `new`

## Recent Actions
- `2026-09-23T00:48:01` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T00:46:59` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T00:45:57` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T00:44:54` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T00:43:52` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T00:42:50` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T00:41:48` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T00:40:45` `-` `monitor_heartbeat`: details_redacted_use_local_logs
