...
Снимок: 2026-09-22 01:53:51 Нью-Йорк
У брокера: позиций 1, открытых заявок 1.
Капитал $27,591.06; деньги на счёте $26,583.66.
Лимит покупок брокера $54,174.72: может включать заёмные средства, это не бюджет новой сделки.
...
- Generated: `2026-09-22T05:53:51+00:00`
- Market open: `no`
- Orders enabled: `yes`
...
## Positions
- `MSFT` qty `2`, avg `$492.00`, price `$503.70`, value `$1007.40`, P/L `$23.40` (`+2.38%`), today `+0.42%`

## Open Orders
- `MSFT` sell stop qty `2`, limit `-`, status `accepted`

## Recent Actions
- `2026-09-22T05:52:51` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T05:51:49` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T05:50:47` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T05:49:44` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T05:48:42` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T05:47:40` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T05:46:37` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T05:45:35` `-` `monitor_heartbeat`: details_redacted_use_local_logs
