...
Снимок: 2026-09-22 07:11:29 Нью-Йорк
У брокера: позиций 1, открытых заявок 1.
Капитал $27,595.48; деньги на счёте $26,583.66.
Лимит покупок брокера $54,179.14: может включать заёмные средства, это не бюджет новой сделки.
...
- Generated: `2026-09-22T11:11:29+00:00`
- Market open: `no`
- Orders enabled: `yes`
...
## Positions
- `MSFT` qty `2`, avg `$492.00`, price `$505.91`, value `$1011.82`, P/L `$27.82` (`+2.83%`), today `+0.86%`

## Open Orders
- `MSFT` sell stop qty `2`, limit `-`, status `new`

## Recent Actions
- `2026-09-22T11:11:17` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T11:10:15` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T11:09:13` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T11:08:11` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T11:07:08` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T11:06:06` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T11:05:04` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T11:04:02` `-` `monitor_heartbeat`: details_redacted_use_local_logs
