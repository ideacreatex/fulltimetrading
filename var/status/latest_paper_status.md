...
Снимок: 2026-09-25 18:57:01 Нью-Йорк
У брокера: позиций 1, открытых заявок 1.
Капитал $27,619.81; деньги на счёте $26,583.66.
Лимит покупок брокера $54,203.47: может включать заёмные средства, это не бюджет новой сделки.
...
- Generated: `2026-09-25T22:57:01+00:00`
- Market open: `no`
- Orders enabled: `yes`
...
## Positions
- `MSFT` qty `2`, avg `$492.00`, price `$518.08`, value `$1036.15`, P/L `$52.15` (`+5.30%`), today `+4.05%`

## Open Orders
- `MSFT` sell stop qty `2`, limit `-`, status `accepted`

## Recent Actions
- `2026-09-25T22:56:41` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T22:55:39` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T22:54:36` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T22:53:34` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T22:52:32` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T22:51:30` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T22:50:28` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T22:49:26` `-` `monitor_heartbeat`: details_redacted_use_local_logs
