...
Снимок: 2026-09-23 17:32:04 Нью-Йорк
У брокера: позиций 1, открытых заявок 1.
Капитал $27,582.68; деньги на счёте $26,583.66.
Лимит покупок брокера $54,166.34: может включать заёмные средства, это не бюджет новой сделки.
...
- Generated: `2026-09-23T21:32:04+00:00`
- Market open: `no`
- Orders enabled: `yes`
...
## Positions
- `MSFT` qty `2`, avg `$492.00`, price `$499.51`, value `$999.02`, P/L `$15.02` (`+1.53%`), today `+0.30%`

## Open Orders
- `MSFT` sell stop qty `2`, limit `-`, status `new`

## Recent Actions
- `2026-09-23T21:32:00` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T21:30:58` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T21:29:56` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T21:28:54` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T21:27:51` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T21:26:49` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T21:25:47` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T21:24:45` `-` `monitor_heartbeat`: details_redacted_use_local_logs
