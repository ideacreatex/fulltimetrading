...
Снимок: 2026-09-23 21:33:58 Нью-Йорк
У брокера: позиций 1, открытых заявок 1.
Капитал $27,583.40; деньги на счёте $26,583.66.
Лимит покупок брокера $54,167.06: может включать заёмные средства, это не бюджет новой сделки.
...
- Generated: `2026-09-24T01:33:58+00:00`
- Market open: `no`
- Orders enabled: `yes`
...
## Positions
- `MSFT` qty `2`, avg `$492.00`, price `$499.87`, value `$999.74`, P/L `$15.74` (`+1.60%`), today `+0.38%`

## Open Orders
- `MSFT` sell stop qty `2`, limit `-`, status `new`

## Recent Actions
- `2026-09-24T01:33:22` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-24T01:32:20` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-24T01:31:18` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-24T01:30:16` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-24T01:29:13` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-24T01:28:11` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-24T01:27:09` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-24T01:26:07` `-` `monitor_heartbeat`: details_redacted_use_local_logs
