...
Снимок: 2026-09-21 08:15:13 Нью-Йорк
У брокера: позиций 1, открытых заявок 1.
Капитал $27,574.16; деньги на счёте $26,583.66.
Лимит покупок брокера $54,157.82: может включать заёмные средства, это не бюджет новой сделки.
...
- Generated: `2026-09-21T12:15:13+00:00`
- Market open: `no`
- Orders enabled: `yes`
...
## Positions
- `MSFT` qty `2`, avg `$492.00`, price `$495.25`, value `$990.50`, P/L `$6.50` (`+0.66%`), today `+0.30%`

## Open Orders
- `MSFT` sell stop qty `2`, limit `-`, status `new`

## Recent Actions
- `2026-09-21T12:14:25` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T12:13:23` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T12:12:21` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T12:11:19` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T12:10:16` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T12:09:14` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T12:08:12` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T12:07:10` `-` `monitor_heartbeat`: details_redacted_use_local_logs
