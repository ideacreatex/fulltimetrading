...
Снимок: 2026-09-22 01:08:29 Нью-Йорк
У брокера: позиций 1, открытых заявок 1.
Капитал $27,588.90; деньги на счёте $26,583.66.
Лимит покупок брокера $54,172.56: может включать заёмные средства, это не бюджет новой сделки.
...
- Generated: `2026-09-22T05:08:29+00:00`
- Market open: `no`
- Orders enabled: `yes`
...
## Positions
- `MSFT` qty `2`, avg `$492.00`, price `$502.62`, value `$1005.24`, P/L `$21.24` (`+2.16%`), today `+0.20%`

## Open Orders
- `MSFT` sell stop qty `2`, limit `-`, status `accepted`

## Recent Actions
- `2026-09-22T05:08:16` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T05:07:14` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T05:06:12` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T05:05:10` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T05:04:08` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T05:03:05` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T05:02:03` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T05:01:01` `-` `monitor_heartbeat`: details_redacted_use_local_logs
