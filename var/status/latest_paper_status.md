...
Снимок: 2026-09-25 12:23:43 Нью-Йорк
...
- Generated: `2026-09-25T16:23:43+00:00`
- Market open: `yes`
- Orders enabled: `yes`
...
## Positions
- `MSFT` qty `2`, avg `$492.00`, price `$514.54`, value `$1029.08`, P/L `$45.08` (`+4.58%`), today `+3.34%`

## Open Orders
- `MSFT` sell stop qty `2`, limit `-`, status `new`

## Recent Actions
- `2026-09-25T16:23:03` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T16:22:01` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T16:20:59` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T16:19:57` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T16:18:55` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T16:17:52` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T16:16:50` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T16:15:48` `-` `monitor_heartbeat`: details_redacted_use_local_logs
