...
Снимок: 2026-09-23 23:04:42 Нью-Йорк
У брокера: позиций 1, открытых заявок 1.
Капитал $27,582.42; деньги на счёте $26,583.66.
Лимит покупок брокера $54,166.08: может включать заёмные средства, это не бюджет новой сделки.
...
- Generated: `2026-09-24T03:04:42+00:00`
- Market open: `no`
- Orders enabled: `yes`
...
## Positions
- `MSFT` qty `2`, avg `$492.00`, price `$499.38`, value `$998.76`, P/L `$14.76` (`+1.50%`), today `-0.24%`

## Open Orders
- `MSFT` sell stop qty `2`, limit `-`, status `new`

## Recent Actions
- `2026-09-24T03:04:32` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-24T03:03:30` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-24T03:02:28` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-24T03:01:26` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-24T03:00:24` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-24T02:59:21` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-24T02:58:19` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-24T02:57:17` `-` `monitor_heartbeat`: details_redacted_use_local_logs
