...
Снимок: 2026-09-22 23:49:48 Нью-Йорк
У брокера: позиций 1, открытых заявок 1.
Капитал $27,583.76; деньги на счёте $26,583.66.
Лимит покупок брокера $54,167.42: может включать заёмные средства, это не бюджет новой сделки.
...
- Generated: `2026-09-23T03:49:48+00:00`
- Market open: `no`
- Orders enabled: `yes`
...
## Positions
- `MSFT` qty `2`, avg `$492.00`, price `$500.05`, value `$1000.10`, P/L `$16.10` (`+1.64%`), today `+0.41%`

## Open Orders
- `MSFT` sell stop qty `2`, limit `-`, status `new`

## Recent Actions
- `2026-09-23T03:49:29` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T03:48:27` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T03:47:24` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T03:46:22` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T03:45:20` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T03:44:18` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T03:43:16` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T03:42:14` `-` `monitor_heartbeat`: details_redacted_use_local_logs
