...
Снимок: 2026-09-23 00:50:16 Нью-Йорк
У брокера: позиций 1, открытых заявок 1.
Капитал $27,584.22; деньги на счёте $26,583.66.
Лимит покупок брокера $54,167.88: может включать заёмные средства, это не бюджет новой сделки.
...
- Generated: `2026-09-23T04:50:16+00:00`
- Market open: `no`
- Orders enabled: `yes`
...
## Positions
- `MSFT` qty `2`, avg `$492.00`, price `$500.28`, value `$1000.56`, P/L `$16.56` (`+1.68%`), today `+0.46%`

## Open Orders
- `MSFT` sell stop qty `2`, limit `-`, status `new`

## Recent Actions
- `2026-09-23T04:49:38` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T04:48:35` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T04:47:33` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T04:46:31` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T04:45:29` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T04:44:27` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T04:43:25` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T04:42:22` `-` `monitor_heartbeat`: details_redacted_use_local_logs
