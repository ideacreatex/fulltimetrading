...
Снимок: 2026-09-22 02:24:05 Нью-Йорк
У брокера: позиций 1, открытых заявок 1.
Капитал $27,590.90; деньги на счёте $26,583.66.
Лимит покупок брокера $54,174.56: может включать заёмные средства, это не бюджет новой сделки.
...
- Generated: `2026-09-22T06:24:05+00:00`
- Market open: `no`
- Orders enabled: `yes`
...
## Positions
- `MSFT` qty `2`, avg `$492.00`, price `$503.62`, value `$1007.24`, P/L `$23.24` (`+2.36%`), today `+0.40%`

## Open Orders
- `MSFT` sell stop qty `2`, limit `-`, status `accepted`

## Recent Actions
- `2026-09-22T06:23:57` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T06:22:55` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T06:21:53` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T06:20:51` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T06:19:48` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T06:18:46` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T06:17:44` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T06:16:42` `-` `monitor_heartbeat`: details_redacted_use_local_logs
