...
Снимок: 2026-09-21 04:28:23 Нью-Йорк
У брокера: позиций 1, открытых заявок 1.
Капитал $27,571.74; деньги на счёте $26,583.66.
Лимит покупок брокера $54,155.40: может включать заёмные средства, это не бюджет новой сделки.
...
- Generated: `2026-09-21T08:28:23+00:00`
- Market open: `no`
- Orders enabled: `yes`
...
## Positions
- `MSFT` qty `2`, avg `$492.00`, price `$494.04`, value `$988.08`, P/L `$4.08` (`+0.41%`), today `+0.05%`

## Open Orders
- `MSFT` sell stop qty `2`, limit `-`, status `new`

## Recent Actions
- `2026-09-21T08:27:20` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T08:26:18` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T08:25:15` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T08:24:13` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T08:23:11` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T08:22:09` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T08:21:06` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T08:20:04` `-` `monitor_heartbeat`: details_redacted_use_local_logs
