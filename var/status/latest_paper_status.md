...
Снимок: 2026-09-25 13:24:15 Нью-Йорк
У брокера: позиций 1, открытых заявок 1.
Капитал $27,617.00; деньги на счёте $26,583.66.
Лимит покупок брокера $54,200.66: может включать заёмные средства, это не бюджет новой сделки.
...
- Generated: `2026-09-25T17:24:15+00:00`
- Market open: `yes`
- Orders enabled: `yes`
...
## Positions
- `MSFT` qty `2`, avg `$492.00`, price `$516.67`, value `$1033.34`, P/L `$49.34` (`+5.01%`), today `+3.76%`

## Open Orders
- `MSFT` sell stop qty `2`, limit `-`, status `new`

## Recent Actions
- `2026-09-25T17:23:17` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T17:22:15` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T17:21:13` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T17:20:10` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T17:19:08` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T17:18:06` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T17:17:03` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T17:16:01` `-` `monitor_heartbeat`: details_redacted_use_local_logs
