...
Снимок: 2026-09-22 23:19:33 Нью-Йорк
У брокера: позиций 1, открытых заявок 1.
Капитал $27,583.86; деньги на счёте $26,583.66.
Лимит покупок брокера $54,167.52: может включать заёмные средства, это не бюджет новой сделки.
...
- Generated: `2026-09-23T03:19:33+00:00`
- Market open: `no`
- Orders enabled: `yes`
...
## Positions
- `MSFT` qty `2`, avg `$492.00`, price `$500.10`, value `$1000.20`, P/L `$16.20` (`+1.65%`), today `+0.42%`

## Open Orders
- `MSFT` sell stop qty `2`, limit `-`, status `new`

## Recent Actions
- `2026-09-23T03:19:26` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T03:18:24` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T03:17:22` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T03:16:19` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T03:15:17` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T03:14:15` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T03:13:13` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T03:12:11` `-` `monitor_heartbeat`: details_redacted_use_local_logs
