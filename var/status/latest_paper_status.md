...
Снимок: 2026-09-21 22:22:11 Нью-Йорк
У брокера: позиций 1, открытых заявок 1.
Капитал $27,586.56; деньги на счёте $26,583.66.
Лимит покупок брокера $54,170.22: может включать заёмные средства, это не бюджет новой сделки.
...
- Generated: `2026-09-22T02:22:11+00:00`
- Market open: `no`
- Orders enabled: `yes`
...
## Positions
- `MSFT` qty `2`, avg `$492.00`, price `$501.45`, value `$1002.90`, P/L `$18.90` (`+1.92%`), today `-0.03%`

## Open Orders
- `MSFT` sell stop qty `2`, limit `-`, status `accepted`

## Recent Actions
- `2026-09-22T02:21:26` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T02:20:23` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T02:19:21` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T02:18:19` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T02:17:17` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T02:16:15` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T02:15:13` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T02:14:10` `-` `monitor_heartbeat`: details_redacted_use_local_logs
