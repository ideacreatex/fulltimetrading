...
Снимок: 2026-09-21 20:36:20 Нью-Йорк
У брокера: позиций 1, открытых заявок 1.
Капитал $27,586.74; деньги на счёте $26,583.66.
Лимит покупок брокера $54,170.40: может включать заёмные средства, это не бюджет новой сделки.
...
- Generated: `2026-09-22T00:36:20+00:00`
- Market open: `no`
- Orders enabled: `yes`
...
## Positions
- `MSFT` qty `2`, avg `$492.00`, price `$501.54`, value `$1003.08`, P/L `$19.08` (`+1.94%`), today `+1.57%`

## Open Orders
- `MSFT` sell stop qty `2`, limit `-`, status `accepted`

## Recent Actions
- `2026-09-22T00:35:41` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T00:34:39` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T00:33:37` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T00:32:35` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T00:31:32` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T00:30:30` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T00:29:28` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T00:28:26` `-` `monitor_heartbeat`: details_redacted_use_local_logs
