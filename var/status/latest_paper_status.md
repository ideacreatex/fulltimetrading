...
Снимок: 2026-09-18 09:56:42 Нью-Йорк
У брокера: позиций 1, открытых заявок 1.
Капитал $27,572.08; деньги на счёте $26,583.66.
Лимит покупок брокера $54,155.74: может включать заёмные средства, это не бюджет новой сделки.
...
- Generated: `2026-09-18T13:56:42+00:00`
- Market open: `yes`
- Orders enabled: `yes`
...
## Positions
- `MSFT` qty `2`, avg `$492.00`, price `$494.07`, value `$988.14`, P/L `$4.14` (`+0.42%`), today `-0.74%`

## Open Orders
- `MSFT` sell stop qty `2`, limit `-`, status `new`

## Recent Actions
- `2026-09-18T13:55:38` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-18T13:54:36` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-18T13:53:34` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-18T13:52:31` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-18T13:51:29` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-18T13:50:26` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-18T13:49:23` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-18T13:48:21` `-` `monitor_heartbeat`: details_redacted_use_local_logs
