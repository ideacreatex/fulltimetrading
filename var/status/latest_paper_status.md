...
Снимок: 2026-09-17 11:45:48 Нью-Йорк
У брокера: позиций 1, открытых заявок 1.
Капитал $27,578.69; деньги на счёте $26,583.66.
Лимит покупок брокера $54,162.35: может включать заёмные средства, это не бюджет новой сделки.
...
- Generated: `2026-09-17T15:45:48+00:00`
- Market open: `yes`
- Orders enabled: `yes`
...
## Positions
- `MSFT` qty `2`, avg `$492.00`, price `$497.51`, value `$995.03`, P/L `$11.03` (`+1.12%`), today `+1.47%`

## Open Orders
- `MSFT` sell stop qty `2`, limit `-`, status `new`

## Recent Actions
- `2026-09-17T15:45:17` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-17T15:44:15` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-17T15:43:13` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-17T15:42:11` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-17T15:41:08` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-17T15:40:06` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-17T15:39:04` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-17T15:38:02` `-` `monitor_heartbeat`: details_redacted_use_local_logs
