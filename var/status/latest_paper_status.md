...
Снимок: 2026-09-24 22:01:33 Нью-Йорк
У брокера: позиций 1, открытых заявок 1.
Капитал $27,576.78; деньги на счёте $26,583.66.
Лимит покупок брокера $54,160.44: может включать заёмные средства, это не бюджет новой сделки.
...
- Generated: `2026-09-25T02:01:33+00:00`
- Market open: `no`
- Orders enabled: `yes`
...
## Positions
- `MSFT` qty `2`, avg `$492.00`, price `$496.56`, value `$993.12`, P/L `$9.12` (`+0.93%`), today `-0.80%`

## Open Orders
- `MSFT` sell stop qty `2`, limit `-`, status `new`

## Recent Actions
- `2026-09-25T02:01:02` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T02:00:00` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T01:58:58` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T01:57:56` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T01:56:54` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T01:55:51` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T01:54:49` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T01:53:47` `-` `monitor_heartbeat`: details_redacted_use_local_logs
