...
Снимок: 2026-09-20 22:10:19 Нью-Йорк
У брокера: позиций 1, открытых заявок 1.
Капитал $27,573.66; деньги на счёте $26,583.66.
Лимит покупок брокера $54,157.32: может включать заёмные средства, это не бюджет новой сделки.
...
- Generated: `2026-09-21T02:10:19+00:00`
- Market open: `no`
- Orders enabled: `yes`
...
## Positions
- `MSFT` qty `2`, avg `$492.00`, price `$495.00`, value `$990.00`, P/L `$6.00` (`+0.61%`), today `+0.25%`

## Open Orders
- `MSFT` sell stop qty `2`, limit `-`, status `new`

## Recent Actions
- `2026-09-21T02:09:46` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T02:08:43` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T02:07:41` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T02:06:38` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T02:05:36` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T02:04:34` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T02:03:32` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T02:02:30` `-` `monitor_heartbeat`: details_redacted_use_local_logs
