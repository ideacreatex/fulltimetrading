...
Снимок: 2026-09-21 15:49:03 Нью-Йорк
У брокера: позиций 1, открытых заявок 1.
Капитал $27,585.52; деньги на счёте $26,583.66.
Лимит покупок брокера $54,169.18: может включать заёмные средства, это не бюджет новой сделки.
...
- Generated: `2026-09-21T19:49:03+00:00`
- Market open: `yes`
- Orders enabled: `yes`
...
## Positions
- `MSFT` qty `2`, avg `$492.00`, price `$500.90`, value `$1001.80`, P/L `$17.80` (`+1.81%`), today `+1.44%`

## Open Orders
- `MSFT` sell stop qty `2`, limit `-`, status `new`

## Recent Actions
- `2026-09-21T19:48:28` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T19:47:26` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T19:46:24` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T19:45:21` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T19:44:19` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T19:43:16` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T19:42:14` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T19:41:12` `-` `monitor_heartbeat`: details_redacted_use_local_logs
