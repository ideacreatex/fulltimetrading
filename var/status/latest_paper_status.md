...
Снимок: 2026-09-22 12:13:59 Нью-Йорк
У брокера: позиций 1, открытых заявок 1.
Капитал $27,574.82; деньги на счёте $26,583.66.
Лимит покупок брокера $54,158.48: может включать заёмные средства, это не бюджет новой сделки.
...
- Generated: `2026-09-22T16:13:59+00:00`
- Market open: `yes`
- Orders enabled: `yes`
...
## Positions
- `MSFT` qty `2`, avg `$492.00`, price `$495.58`, value `$991.16`, P/L `$7.16` (`+0.73%`), today `-1.20%`

## Open Orders
- `MSFT` sell stop qty `2`, limit `-`, status `new`

## Recent Actions
- `2026-09-22T16:13:19` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T16:12:17` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T16:11:15` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T16:10:12` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T16:09:10` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T16:08:07` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T16:07:05` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T16:06:03` `-` `monitor_heartbeat`: details_redacted_use_local_logs
