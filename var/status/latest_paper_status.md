...
Снимок: 2026-09-22 18:17:07 Нью-Йорк
У брокера: позиций 1, открытых заявок 1.
Капитал $27,584.16; деньги на счёте $26,583.66.
Лимит покупок брокера $54,167.82: может включать заёмные средства, это не бюджет новой сделки.
...
- Generated: `2026-09-22T22:17:07+00:00`
- Market open: `no`
- Orders enabled: `yes`
...
- Telegram outbox: `0 pending, 0 failed pending, 131 delivered`
...
## Positions
- `MSFT` qty `2`, avg `$492.00`, price `$500.25`, value `$1000.50`, P/L `$16.50` (`+1.68%`), today `-0.27%`

## Open Orders
- `MSFT` sell stop qty `2`, limit `-`, status `new`

## Recent Actions
- `2026-09-22T22:16:33` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T22:15:30` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T22:14:28` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T22:13:26` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T22:12:24` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T22:11:21` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T22:10:19` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T22:09:17` `-` `monitor_heartbeat`: details_redacted_use_local_logs
