...
Снимок: 2026-09-16 12:35:51 Нью-Йорк
У брокера: позиций 1, открытых заявок 1.
Капитал $27,570.70; деньги на счёте $26,583.66.
Лимит покупок брокера $54,154.36: может включать заёмные средства, это не бюджет новой сделки.
...
- Generated: `2026-09-16T16:35:51+00:00`
- Market open: `yes`
- Orders enabled: `yes`
...
## Positions
- `MSFT` qty `2`, avg `$492.00`, price `$493.52`, value `$987.04`, P/L `$3.04` (`+0.31%`), today `-0.72%`

## Open Orders
- `MSFT` sell stop qty `2`, limit `-`, status `new`

## Recent Actions
- `2026-09-16T16:34:53` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-16T16:33:51` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-16T16:32:49` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-16T16:31:46` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-16T16:30:44` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-16T16:29:42` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-16T16:28:40` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-16T16:27:37` `-` `monitor_heartbeat`: details_redacted_use_local_logs
