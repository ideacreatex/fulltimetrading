...
Снимок: 2026-09-25 01:48:22 Нью-Йорк
У брокера: позиций 1, открытых заявок 1.
Капитал $27,578.66; деньги на счёте $26,583.66.
Лимит покупок брокера $54,162.32: может включать заёмные средства, это не бюджет новой сделки.
...
- Generated: `2026-09-25T05:48:22+00:00`
- Market open: `no`
- Orders enabled: `yes`
...
## Positions
- `MSFT` qty `2`, avg `$492.00`, price `$497.50`, value `$995.00`, P/L `$11.00` (`+1.12%`), today `-0.09%`

## Open Orders
- `MSFT` sell stop qty `2`, limit `-`, status `new`

## Recent Actions
- `2026-09-25T05:47:56` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T05:46:54` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T05:45:51` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T05:44:49` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T05:43:47` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T05:42:45` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T05:41:42` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T05:40:40` `-` `monitor_heartbeat`: details_redacted_use_local_logs
