...
Снимок: 2026-09-24 23:02:02 Нью-Йорк
У брокера: позиций 1, открытых заявок 1.
Капитал $27,577.68; деньги на счёте $26,583.66.
Лимит покупок брокера $54,161.34: может включать заёмные средства, это не бюджет новой сделки.
...
- Generated: `2026-09-25T03:02:02+00:00`
- Market open: `no`
- Orders enabled: `yes`
...
## Positions
- `MSFT` qty `2`, avg `$492.00`, price `$497.01`, value `$994.02`, P/L `$10.02` (`+1.02%`), today `-0.18%`

## Open Orders
- `MSFT` sell stop qty `2`, limit `-`, status `new`

## Recent Actions
- `2026-09-25T03:01:07` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T03:00:04` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T02:59:02` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T02:58:00` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T02:56:58` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T02:55:56` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T02:54:54` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T02:53:52` `-` `monitor_heartbeat`: details_redacted_use_local_logs
