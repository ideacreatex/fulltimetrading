...
Снимок: 2026-09-21 10:01:06 Нью-Йорк
У брокера: позиций 1, открытых заявок 1.
Капитал $27,574.04; деньги на счёте $26,583.66.
Лимит покупок брокера $54,157.70: может включать заёмные средства, это не бюджет новой сделки.
...
- Generated: `2026-09-21T14:01:06+00:00`
- Market open: `yes`
- Orders enabled: `yes`
...
## Positions
- `MSFT` qty `2`, avg `$492.00`, price `$495.31`, value `$990.61`, P/L `$6.61` (`+0.67%`), today `+0.31%`

## Open Orders
- `MSFT` sell stop qty `2`, limit `-`, status `new`

## Recent Actions
- `2026-09-21T14:00:19` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T13:59:16` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T13:58:14` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T13:57:12` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T13:56:09` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T13:55:07` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T13:54:04` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T13:53:02` `-` `monitor_heartbeat`: details_redacted_use_local_logs
