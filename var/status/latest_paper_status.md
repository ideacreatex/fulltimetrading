...
Снимок: 2026-09-21 06:59:36 Нью-Йорк
У брокера: позиций 1, открытых заявок 1.
Капитал $27,574.66; деньги на счёте $26,583.66.
Лимит покупок брокера $54,158.32: может включать заёмные средства, это не бюджет новой сделки.
...
- Generated: `2026-09-21T10:59:36+00:00`
- Market open: `no`
- Orders enabled: `yes`
...
## Positions
- `MSFT` qty `2`, avg `$492.00`, price `$495.50`, value `$991.00`, P/L `$7.00` (`+0.71%`), today `+0.35%`

## Open Orders
- `MSFT` sell stop qty `2`, limit `-`, status `new`

## Recent Actions
- `2026-09-21T10:58:43` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T10:57:40` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T10:56:38` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T10:55:36` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T10:54:34` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T10:53:32` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T10:52:30` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T10:51:27` `-` `monitor_heartbeat`: details_redacted_use_local_logs
