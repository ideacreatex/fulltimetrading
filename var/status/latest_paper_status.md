...
Снимок: 2026-09-24 00:35:27 Нью-Йорк
У брокера: позиций 1, открытых заявок 1.
Капитал $27,581.16; деньги на счёте $26,583.66.
Лимит покупок брокера $54,164.82: может включать заёмные средства, это не бюджет новой сделки.
...
- Generated: `2026-09-24T04:35:27+00:00`
- Market open: `no`
- Orders enabled: `yes`
...
## Positions
- `MSFT` qty `2`, avg `$492.00`, price `$498.75`, value `$997.50`, P/L `$13.50` (`+1.37%`), today `-0.37%`

## Open Orders
- `MSFT` sell stop qty `2`, limit `-`, status `new`

## Recent Actions
- `2026-09-24T04:34:43` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-24T04:33:41` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-24T04:32:38` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-24T04:31:36` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-24T04:30:34` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-24T04:29:32` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-24T04:28:30` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-24T04:27:27` `-` `monitor_heartbeat`: details_redacted_use_local_logs
