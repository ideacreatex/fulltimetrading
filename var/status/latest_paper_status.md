...
Снимок: 2026-09-23 09:12:27 Нью-Йорк
У брокера: позиций 1, открытых заявок 1.
Капитал $27,588.92; деньги на счёте $26,583.66.
Лимит покупок брокера $54,172.58: может включать заёмные средства, это не бюджет новой сделки.
...
- Generated: `2026-09-23T13:12:27+00:00`
- Market open: `no`
- Orders enabled: `yes`
...
## Positions
- `MSFT` qty `2`, avg `$492.00`, price `$502.63`, value `$1005.26`, P/L `$21.26` (`+2.16%`), today `+0.93%`

## Open Orders
- `MSFT` sell stop qty `2`, limit `-`, status `new`

## Recent Actions
- `2026-09-23T13:11:30` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T13:10:27` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T13:09:25` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T13:08:23` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T13:07:20` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T13:06:18` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T13:05:16` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T13:04:13` `-` `monitor_heartbeat`: details_redacted_use_local_logs
