...
Снимок: 2026-09-21 20:06:06 Нью-Йорк
У брокера: позиций 1, открытых заявок 1.
Капитал $27,587.18; деньги на счёте $26,583.66.
Лимит покупок брокера $54,170.84: может включать заёмные средства, это не бюджет новой сделки.
...
- Generated: `2026-09-22T00:06:06+00:00`
- Market open: `no`
- Orders enabled: `yes`
...
## Positions
- `MSFT` qty `2`, avg `$492.00`, price `$501.76`, value `$1003.52`, P/L `$19.52` (`+1.98%`), today `+1.62%`

## Open Orders
- `MSFT` sell stop qty `2`, limit `-`, status `accepted`

## Recent Actions
- `2026-09-22T00:05:38` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T00:04:35` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T00:03:33` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T00:02:31` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T00:01:29` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T00:00:27` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T23:59:25` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T23:58:22` `-` `monitor_heartbeat`: details_redacted_use_local_logs
