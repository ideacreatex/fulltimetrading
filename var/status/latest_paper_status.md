...
Снимок: 2026-09-21 06:44:29 Нью-Йорк
У брокера: позиций 1, открытых заявок 1.
Капитал $27,573.68; деньги на счёте $26,583.66.
Лимит покупок брокера $54,157.34: может включать заёмные средства, это не бюджет новой сделки.
...
- Generated: `2026-09-21T10:44:29+00:00`
- Market open: `no`
- Orders enabled: `yes`
...
## Positions
- `MSFT` qty `2`, avg `$492.00`, price `$495.01`, value `$990.02`, P/L `$6.02` (`+0.61%`), today `+0.25%`

## Open Orders
- `MSFT` sell stop qty `2`, limit `-`, status `new`

## Recent Actions
- `2026-09-21T10:44:12` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T10:43:10` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T10:42:08` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T10:41:06` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T10:40:03` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T10:39:01` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T10:37:59` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T10:36:57` `-` `monitor_heartbeat`: details_redacted_use_local_logs
