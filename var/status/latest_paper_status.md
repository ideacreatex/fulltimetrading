...
Снимок: 2026-09-22 15:00:26 Нью-Йорк
У брокера: позиций 1, открытых заявок 1.
Капитал $27,580.70; деньги на счёте $26,583.66.
Лимит покупок брокера $54,164.36: может включать заёмные средства, это не бюджет новой сделки.
...
- Generated: `2026-09-22T19:00:26+00:00`
- Market open: `yes`
- Orders enabled: `yes`
...
## Positions
- `MSFT` qty `2`, avg `$492.00`, price `$498.45`, value `$996.90`, P/L `$12.90` (`+1.31%`), today `-0.63%`

## Open Orders
- `MSFT` sell stop qty `2`, limit `-`, status `new`

## Recent Actions
- `2026-09-22T18:59:57` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T18:58:55` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T18:57:52` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T18:56:50` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T18:55:48` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T18:54:45` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T18:53:43` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T18:52:40` `-` `monitor_heartbeat`: details_redacted_use_local_logs
