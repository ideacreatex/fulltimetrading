...
Снимок: 2026-09-22 03:09:28 Нью-Йорк
У брокера: позиций 1, открытых заявок 1.
Капитал $27,590.08; деньги на счёте $26,583.66.
Лимит покупок брокера $54,173.74: может включать заёмные средства, это не бюджет новой сделки.
...
- Generated: `2026-09-22T07:09:28+00:00`
- Market open: `no`
- Orders enabled: `yes`
...
## Positions
- `MSFT` qty `2`, avg `$492.00`, price `$503.21`, value `$1006.42`, P/L `$22.42` (`+2.28%`), today `+0.32%`

## Open Orders
- `MSFT` sell stop qty `2`, limit `-`, status `accepted`

## Recent Actions
- `2026-09-22T07:08:34` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T07:07:31` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T07:06:29` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T07:05:26` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T07:04:24` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T07:03:22` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T07:02:20` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T07:01:17` `-` `monitor_heartbeat`: details_redacted_use_local_logs
