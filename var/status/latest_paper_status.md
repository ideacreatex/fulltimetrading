...
Снимок: 2026-09-18 11:57:45 Нью-Йорк
У брокера: позиций 1, открытых заявок 1.
Капитал $27,571.59; деньги на счёте $26,583.66.
Лимит покупок брокера $54,155.25: может включать заёмные средства, это не бюджет новой сделки.
...
- Generated: `2026-09-18T15:57:45+00:00`
- Market open: `yes`
- Orders enabled: `yes`
...
## Positions
- `MSFT` qty `2`, avg `$492.00`, price `$493.96`, value `$987.93`, P/L `$3.93` (`+0.40%`), today `-0.76%`

## Open Orders
- `MSFT` sell stop qty `2`, limit `-`, status `new`

## Recent Actions
- `2026-09-18T15:57:09` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-18T15:56:07` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-18T15:55:05` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-18T15:54:02` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-18T15:53:00` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-18T15:51:58` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-18T15:50:55` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-18T15:49:53` `-` `monitor_heartbeat`: details_redacted_use_local_logs
