...
Снимок: 2026-09-17 11:30:41 Нью-Йорк
У брокера: позиций 1, открытых заявок 1.
Капитал $27,575.50; деньги на счёте $26,583.66.
Лимит покупок брокера $54,159.16: может включать заёмные средства, это не бюджет новой сделки.
...
- Generated: `2026-09-17T15:30:41+00:00`
- Market open: `yes`
- Orders enabled: `yes`
...
## Positions
- `MSFT` qty `2`, avg `$492.00`, price `$495.96`, value `$991.92`, P/L `$7.92` (`+0.80%`), today `+1.15%`

## Open Orders
- `MSFT` sell stop qty `2`, limit `-`, status `new`

## Recent Actions
- `2026-09-17T15:29:44` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-17T15:28:41` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-17T15:27:38` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-17T15:26:35` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-17T15:25:33` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-17T15:24:31` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-17T15:23:28` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-17T15:22:26` `-` `monitor_heartbeat`: details_redacted_use_local_logs
