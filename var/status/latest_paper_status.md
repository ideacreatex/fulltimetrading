...
Снимок: 2026-09-17 23:21:27 Нью-Йорк
У брокера: позиций 1, открытых заявок 1.
Капитал $27,577.62; деньги на счёте $26,583.66.
Лимит покупок брокера $54,161.28: может включать заёмные средства, это не бюджет новой сделки.
...
- Generated: `2026-09-18T03:21:27+00:00`
- Market open: `no`
- Orders enabled: `yes`
...
## Positions
- `MSFT` qty `2`, avg `$492.00`, price `$496.98`, value `$993.96`, P/L `$9.96` (`+1.01%`), today `-0.15%`

## Open Orders
- `MSFT` sell stop qty `2`, limit `-`, status `accepted`

## Recent Actions
- `2026-09-18T03:20:39` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-18T03:19:36` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-18T03:18:34` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-18T03:17:31` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-18T03:16:29` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-18T03:15:26` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-18T03:14:24` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-18T03:13:22` `-` `monitor_heartbeat`: details_redacted_use_local_logs
