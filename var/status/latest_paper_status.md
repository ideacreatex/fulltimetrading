...
Снимок: 2026-09-18 04:23:57 Нью-Йорк
У брокера: позиций 1, открытых заявок 1.
Капитал $27,579.66; деньги на счёте $26,583.66.
Лимит покупок брокера $54,163.32: может включать заёмные средства, это не бюджет новой сделки.
...
- Generated: `2026-09-18T08:23:57+00:00`
- Market open: `no`
- Orders enabled: `yes`
...
- Equity: `$27,579.66`
- Cash: `$26,583.66`
- Buying power: `$54,163.32`
- Hybrid-v4 runtime: `active`
- Hybrid-v4 health: `healthy`
- Telegram outbox: `0 pending, 0 failed pending, 112 delivered`
...
## Positions
- `MSFT` qty `2`, avg `$492.00`, price `$498.00`, value `$996.00`, P/L `$12.00` (`+1.22%`), today `+0.05%`

## Open Orders
- `MSFT` sell stop qty `2`, limit `-`, status `new`

## Recent Actions
- `2026-09-18T08:23:53` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-18T08:22:50` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-18T08:21:48` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-18T08:20:46` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-18T08:19:44` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-18T08:18:41` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-18T08:17:39` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-18T08:16:37` `-` `monitor_heartbeat`: details_redacted_use_local_logs
