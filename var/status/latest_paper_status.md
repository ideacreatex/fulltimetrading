...
Снимок: 2026-09-24 02:06:11 Нью-Йорк
У брокера: позиций 1, открытых заявок 1.
Капитал $27,579.10; деньги на счёте $26,583.66.
Лимит покупок брокера $54,162.76: может включать заёмные средства, это не бюджет новой сделки.
...
- Generated: `2026-09-24T06:06:11+00:00`
- Market open: `no`
- Orders enabled: `yes`
...
## Positions
- `MSFT` qty `2`, avg `$492.00`, price `$497.72`, value `$995.44`, P/L `$11.44` (`+1.16%`), today `-0.57%`

## Open Orders
- `MSFT` sell stop qty `2`, limit `-`, status `new`

## Recent Actions
- `2026-09-24T06:05:58` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-24T06:04:56` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-24T06:03:54` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-24T06:02:52` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-24T06:01:50` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-24T06:00:47` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-24T05:59:45` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-24T05:58:42` `-` `monitor_heartbeat`: details_redacted_use_local_logs
