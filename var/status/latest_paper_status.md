...
Снимок: 2026-09-21 18:50:30 Нью-Йорк
У брокера: позиций 1, открытых заявок 1.
Капитал $27,587.16; деньги на счёте $26,583.66.
Лимит покупок брокера $54,170.82: может включать заёмные средства, это не бюджет новой сделки.
...
- Generated: `2026-09-21T22:50:30+00:00`
- Market open: `no`
- Orders enabled: `yes`
...
## Positions
- `MSFT` qty `2`, avg `$492.00`, price `$501.75`, value `$1003.50`, P/L `$19.50` (`+1.98%`), today `+1.61%`

## Open Orders
- `MSFT` sell stop qty `2`, limit `-`, status `accepted`

## Recent Actions
- `2026-09-21T22:49:56` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T22:48:54` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T22:47:52` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T22:46:50` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T22:45:48` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T22:44:45` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T22:43:43` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T22:42:41` `-` `monitor_heartbeat`: details_redacted_use_local_logs
