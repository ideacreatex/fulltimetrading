...
Снимок: 2026-09-24 13:57:32 Нью-Йорк
У брокера: позиций 1, открытых заявок 1.
Капитал $27,575.98; деньги на счёте $26,583.66.
Лимит покупок брокера $54,159.64: может включать заёмные средства, это не бюджет новой сделки.
...
- Generated: `2026-09-24T17:57:32+00:00`
- Market open: `yes`
- Orders enabled: `yes`
...
## Positions
- `MSFT` qty `2`, avg `$492.00`, price `$496.16`, value `$992.32`, P/L `$8.32` (`+0.85%`), today `-0.89%`

## Open Orders
- `MSFT` sell stop qty `2`, limit `-`, status `new`

## Recent Actions
- `2026-09-24T17:57:18` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-24T17:56:15` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-24T17:55:13` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-24T17:54:10` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-24T17:53:08` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-24T17:52:06` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-24T17:51:03` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-24T17:50:01` `-` `monitor_heartbeat`: details_redacted_use_local_logs
