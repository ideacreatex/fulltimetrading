...
Снимок: 2026-09-18 08:25:58 Нью-Йорк
У брокера: позиций 1, открытых заявок 1.
Капитал $27,575.76; деньги на счёте $26,583.66.
Лимит покупок брокера $54,159.42: может включать заёмные средства, это не бюджет новой сделки.
...
- Generated: `2026-09-18T12:25:58+00:00`
- Market open: `no`
- Orders enabled: `yes`
...
## Positions
- `MSFT` qty `2`, avg `$492.00`, price `$496.05`, value `$992.10`, P/L `$8.10` (`+0.82%`), today `-0.34%`

## Open Orders
- `MSFT` sell stop qty `2`, limit `-`, status `new`

## Recent Actions
- `2026-09-18T12:25:19` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-18T12:24:17` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-18T12:23:15` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-18T12:22:13` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-18T12:21:10` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-18T12:20:08` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-18T12:19:06` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-18T12:18:03` `-` `monitor_heartbeat`: details_redacted_use_local_logs
