...
Снимок: 2026-09-23 18:02:18 Нью-Йорк
У брокера: позиций 1, открытых заявок 1.
Капитал $27,583.72; деньги на счёте $26,583.66.
Лимит покупок брокера $54,167.38: может включать заёмные средства, это не бюджет новой сделки.
...
- Generated: `2026-09-23T22:02:18+00:00`
- Market open: `no`
- Orders enabled: `yes`
...
## Positions
- `MSFT` qty `2`, avg `$492.00`, price `$500.03`, value `$1000.06`, P/L `$16.06` (`+1.63%`), today `+0.41%`

## Open Orders
- `MSFT` sell stop qty `2`, limit `-`, status `new`

## Recent Actions
- `2026-09-23T22:02:02` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T22:01:00` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T21:59:58` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T21:58:56` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T21:57:54` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T21:56:51` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T21:55:49` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T21:54:47` `-` `monitor_heartbeat`: details_redacted_use_local_logs
