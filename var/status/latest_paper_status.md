...
Снимок: 2026-09-23 14:15:23 Нью-Йорк
У брокера: позиций 1, открытых заявок 1.
Капитал $27,582.24; деньги на счёте $26,583.66.
Лимит покупок брокера $54,165.90: может включать заёмные средства, это не бюджет новой сделки.
...
- Generated: `2026-09-23T18:15:23+00:00`
- Market open: `yes`
- Orders enabled: `yes`
...
## Positions
- `MSFT` qty `2`, avg `$492.00`, price `$499.33`, value `$998.66`, P/L `$14.66` (`+1.49%`), today `+0.27%`

## Open Orders
- `MSFT` sell stop qty `2`, limit `-`, status `new`

## Recent Actions
- `2026-09-23T18:14:36` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T18:13:34` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T18:12:31` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T18:11:29` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T18:10:27` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T18:09:25` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T18:08:22` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T18:07:20` `-` `monitor_heartbeat`: details_redacted_use_local_logs
