...
Снимок: 2026-09-21 17:50:02 Нью-Йорк
У брокера: позиций 1, открытых заявок 1.
Капитал $27,586.21; деньги на счёте $26,583.66.
Лимит покупок брокера $54,169.87: может включать заёмные средства, это не бюджет новой сделки.
...
- Generated: `2026-09-21T21:50:02+00:00`
- Market open: `no`
- Orders enabled: `yes`
...
- Telegram outbox: `0 pending, 0 failed pending, 126 delivered`
...
## Positions
- `MSFT` qty `2`, avg `$492.00`, price `$501.28`, value `$1002.55`, P/L `$18.55` (`+1.88%`), today `+1.52%`

## Open Orders
- `MSFT` sell stop qty `2`, limit `-`, status `accepted`

## Recent Actions
- `2026-09-21T21:49:50` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T21:48:48` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T21:47:46` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T21:46:44` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T21:45:42` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T21:44:40` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T21:43:37` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T21:42:35` `-` `monitor_heartbeat`: details_redacted_use_local_logs
