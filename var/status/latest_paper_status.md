...
Снимок: 2026-09-25 01:33:14 Нью-Йорк
У брокера: позиций 1, открытых заявок 1.
Капитал $27,578.40; деньги на счёте $26,583.66.
Лимит покупок брокера $54,162.06: может включать заёмные средства, это не бюджет новой сделки.
...
- Generated: `2026-09-25T05:33:14+00:00`
- Market open: `no`
- Orders enabled: `yes`
...
## Positions
- `MSFT` qty `2`, avg `$492.00`, price `$497.37`, value `$994.74`, P/L `$10.74` (`+1.09%`), today `-0.11%`

## Open Orders
- `MSFT` sell stop qty `2`, limit `-`, status `new`

## Recent Actions
- `2026-09-25T05:32:22` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T05:31:20` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T05:30:18` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T05:29:16` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T05:28:14` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T05:27:11` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T05:26:09` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T05:25:07` `-` `monitor_heartbeat`: details_redacted_use_local_logs
