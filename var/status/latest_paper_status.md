...
Снимок: 2026-09-21 09:45:58 Нью-Йорк
У брокера: позиций 1, открытых заявок 1.
Капитал $27,570.66; деньги на счёте $26,583.66.
Лимит покупок брокера $54,154.32: может включать заёмные средства, это не бюджет новой сделки.
...
- Generated: `2026-09-21T13:45:58+00:00`
- Market open: `yes`
- Orders enabled: `yes`
...
## Positions
- `MSFT` qty `2`, avg `$492.00`, price `$493.56`, value `$987.12`, P/L `$3.12` (`+0.32%`), today `-0.04%`

## Open Orders
- `MSFT` sell stop qty `2`, limit `-`, status `new`

## Recent Actions
- `2026-09-21T13:45:43` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T13:44:41` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T13:43:39` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T13:42:36` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T13:41:34` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T13:40:32` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T13:39:29` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T13:38:27` `-` `monitor_heartbeat`: details_redacted_use_local_logs
