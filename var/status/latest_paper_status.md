...
Снимок: 2026-09-21 07:14:43 Нью-Йорк
У брокера: позиций 1, открытых заявок 1.
Капитал $27,574.95; деньги на счёте $26,583.66.
Лимит покупок брокера $54,158.61: может включать заёмные средства, это не бюджет новой сделки.
...
- Generated: `2026-09-21T11:14:43+00:00`
- Market open: `no`
- Orders enabled: `yes`
...
## Positions
- `MSFT` qty `2`, avg `$492.00`, price `$495.65`, value `$991.29`, P/L `$7.29` (`+0.74%`), today `+0.38%`

## Open Orders
- `MSFT` sell stop qty `2`, limit `-`, status `new`

## Recent Actions
- `2026-09-21T11:14:16` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T11:13:13` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T11:12:11` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T11:11:09` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T11:10:07` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T11:09:05` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T11:08:02` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T11:07:00` `-` `monitor_heartbeat`: details_redacted_use_local_logs
