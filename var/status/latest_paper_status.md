...
Снимок: 2026-09-24 04:52:37 Нью-Йорк
У брокера: позиций 1, открытых заявок 1.
Капитал $27,580.08; деньги на счёте $26,583.66.
Лимит покупок брокера $54,163.74: может включать заёмные средства, это не бюджет новой сделки.
...
- Generated: `2026-09-24T08:52:37+00:00`
- Market open: `no`
- Orders enabled: `yes`
...
## Positions
- `MSFT` qty `2`, avg `$492.00`, price `$498.21`, value `$996.42`, P/L `$12.42` (`+1.26%`), today `-0.47%`

## Open Orders
- `MSFT` sell stop qty `2`, limit `-`, status `new`

## Recent Actions
- `2026-09-24T08:52:10` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-24T08:51:08` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-24T08:50:06` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-24T08:49:04` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-24T08:48:01` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-24T08:46:59` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-24T08:45:57` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-24T08:44:55` `-` `monitor_heartbeat`: details_redacted_use_local_logs
