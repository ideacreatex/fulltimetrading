...
Снимок: 2026-09-21 13:02:36 Нью-Йорк
У брокера: позиций 1, открытых заявок 1.
Капитал $27,576.41; деньги на счёте $26,583.66.
Лимит покупок брокера $54,160.07: может включать заёмные средства, это не бюджет новой сделки.
...
- Generated: `2026-09-21T17:02:36+00:00`
- Market open: `yes`
- Orders enabled: `yes`
...
## Positions
- `MSFT` qty `2`, avg `$492.00`, price `$496.39`, value `$992.78`, P/L `$8.78` (`+0.89%`), today `+0.53%`

## Open Orders
- `MSFT` sell stop qty `2`, limit `-`, status `new`

## Recent Actions
- `2026-09-21T17:02:10` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T17:01:08` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T17:00:06` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T16:59:04` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T16:58:01` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T16:56:59` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T16:55:57` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T16:54:55` `-` `monitor_heartbeat`: details_redacted_use_local_logs
