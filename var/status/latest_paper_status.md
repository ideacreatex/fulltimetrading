...
Снимок: 2026-09-24 08:54:40 Нью-Йорк
У брокера: позиций 1, открытых заявок 1.
Капитал $27,580.72; деньги на счёте $26,583.66.
Лимит покупок брокера $54,164.38: может включать заёмные средства, это не бюджет новой сделки.
...
- Generated: `2026-09-24T12:54:40+00:00`
- Market open: `no`
- Orders enabled: `yes`
...
## Positions
- `MSFT` qty `2`, avg `$492.00`, price `$498.53`, value `$997.06`, P/L `$13.06` (`+1.33%`), today `-0.41%`

## Open Orders
- `MSFT` sell stop qty `2`, limit `-`, status `new`

## Recent Actions
- `2026-09-24T12:53:57` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-24T12:52:55` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-24T12:51:52` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-24T12:50:50` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-24T12:49:48` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-24T12:48:46` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-24T12:47:43` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-24T12:46:41` `-` `monitor_heartbeat`: details_redacted_use_local_logs
