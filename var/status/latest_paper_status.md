...
Снимок: 2026-09-22 02:54:20 Нью-Йорк
У брокера: позиций 1, открытых заявок 1.
Капитал $27,590.22; деньги на счёте $26,583.66.
Лимит покупок брокера $54,173.88: может включать заёмные средства, это не бюджет новой сделки.
...
- Generated: `2026-09-22T06:54:20+00:00`
- Market open: `no`
- Orders enabled: `yes`
...
## Positions
- `MSFT` qty `2`, avg `$492.00`, price `$503.28`, value `$1006.56`, P/L `$22.56` (`+2.29%`), today `+0.33%`

## Open Orders
- `MSFT` sell stop qty `2`, limit `-`, status `accepted`

## Recent Actions
- `2026-09-22T06:54:02` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T06:52:59` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T06:51:57` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T06:50:55` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T06:49:53` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T06:48:50` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T06:47:48` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T06:46:46` `-` `monitor_heartbeat`: details_redacted_use_local_logs
