...
Снимок: 2026-09-22 13:59:52 Нью-Йорк
У брокера: позиций 1, открытых заявок 1.
Капитал $27,576.73; деньги на счёте $26,583.66.
Лимит покупок брокера $54,160.39: может включать заёмные средства, это не бюджет новой сделки.
...
- Generated: `2026-09-22T17:59:52+00:00`
- Market open: `yes`
- Orders enabled: `yes`
...
## Positions
- `MSFT` qty `2`, avg `$492.00`, price `$496.59`, value `$993.18`, P/L `$9.18` (`+0.93%`), today `-1.00%`

## Open Orders
- `MSFT` sell stop qty `2`, limit `-`, status `new`

## Recent Actions
- `2026-09-22T17:59:25` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T17:58:23` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T17:57:21` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T17:56:18` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T17:55:16` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T17:54:13` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T17:53:10` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T17:52:08` `-` `monitor_heartbeat`: details_redacted_use_local_logs
