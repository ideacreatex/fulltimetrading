...
Снимок: 2026-09-23 06:41:12 Нью-Йорк
У брокера: позиций 1, открытых заявок 1.
Капитал $27,588.46; деньги на счёте $26,583.66.
Лимит покупок брокера $54,172.12: может включать заёмные средства, это не бюджет новой сделки.
...
- Generated: `2026-09-23T10:41:12+00:00`
- Market open: `no`
- Orders enabled: `yes`
...
## Positions
- `MSFT` qty `2`, avg `$492.00`, price `$502.40`, value `$1004.80`, P/L `$20.80` (`+2.11%`), today `+0.88%`

## Open Orders
- `MSFT` sell stop qty `2`, limit `-`, status `new`

## Recent Actions
- `2026-09-23T10:41:06` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T10:40:03` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T10:39:01` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T10:37:59` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T10:36:57` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T10:35:55` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T10:34:52` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T10:33:50` `-` `monitor_heartbeat`: details_redacted_use_local_logs
