...
Снимок: 2026-09-22 07:26:36 Нью-Йорк
У брокера: позиций 1, открытых заявок 1.
Капитал $27,595.84; деньги на счёте $26,583.66.
Лимит покупок брокера $54,179.50: может включать заёмные средства, это не бюджет новой сделки.
...
- Generated: `2026-09-22T11:26:36+00:00`
- Market open: `no`
- Orders enabled: `yes`
...
## Positions
- `MSFT` qty `2`, avg `$492.00`, price `$506.16`, value `$1012.32`, P/L `$28.32` (`+2.88%`), today `+0.91%`

## Open Orders
- `MSFT` sell stop qty `2`, limit `-`, status `new`

## Recent Actions
- `2026-09-22T11:25:48` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T11:24:46` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T11:23:44` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T11:22:42` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T11:21:39` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T11:20:37` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T11:19:35` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T11:18:33` `-` `monitor_heartbeat`: details_redacted_use_local_logs
