...
Снимок: 2026-09-22 21:03:29 Нью-Йорк
У брокера: позиций 1, открытых заявок 1.
Капитал $27,582.76; деньги на счёте $26,583.66.
Лимит покупок брокера $54,166.42: может включать заёмные средства, это не бюджет новой сделки.
...
- Generated: `2026-09-23T01:03:29+00:00`
- Market open: `no`
- Orders enabled: `yes`
...
## Positions
- `MSFT` qty `2`, avg `$492.00`, price `$499.55`, value `$999.10`, P/L `$15.10` (`+1.54%`), today `-0.41%`

## Open Orders
- `MSFT` sell stop qty `2`, limit `-`, status `new`

## Recent Actions
- `2026-09-23T01:02:33` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T01:01:30` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T01:00:28` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T00:59:26` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T00:58:24` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T00:57:21` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T00:56:19` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T00:55:17` `-` `monitor_heartbeat`: details_redacted_use_local_logs
