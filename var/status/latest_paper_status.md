...
Снимок: 2026-09-23 02:51:15 Нью-Йорк
У брокера: позиций 1, открытых заявок 1.
Капитал $27,584.66; деньги на счёте $26,583.66.
Лимит покупок брокера $54,168.32: может включать заёмные средства, это не бюджет новой сделки.
...
- Generated: `2026-09-23T06:51:15+00:00`
- Market open: `no`
- Orders enabled: `yes`
...
## Positions
- `MSFT` qty `2`, avg `$492.00`, price `$500.50`, value `$1001.00`, P/L `$17.00` (`+1.73%`), today `+0.50%`

## Open Orders
- `MSFT` sell stop qty `2`, limit `-`, status `new`

## Recent Actions
- `2026-09-23T06:50:56` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T06:49:54` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T06:48:52` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T06:47:50` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T06:46:47` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T06:45:45` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T06:44:43` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T06:43:41` `-` `monitor_heartbeat`: details_redacted_use_local_logs
