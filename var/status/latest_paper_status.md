...
Снимок: 2026-09-22 11:28:36 Нью-Йорк
У брокера: позиций 1, открытых заявок 1.
Капитал $27,573.95; деньги на счёте $26,583.66.
Лимит покупок брокера $54,157.61: может включать заёмные средства, это не бюджет новой сделки.
...
- Generated: `2026-09-22T15:28:36+00:00`
- Market open: `yes`
- Orders enabled: `yes`
...
## Positions
- `MSFT` qty `2`, avg `$492.00`, price `$495.10`, value `$990.20`, P/L `$6.20` (`+0.63%`), today `-1.30%`

## Open Orders
- `MSFT` sell stop qty `2`, limit `-`, status `new`

## Recent Actions
- `2026-09-22T15:27:38` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T15:26:35` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T15:25:33` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T15:24:31` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T15:23:28` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T15:22:26` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T15:21:24` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T15:20:21` `-` `monitor_heartbeat`: details_redacted_use_local_logs
