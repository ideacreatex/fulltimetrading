...
Снимок: 2026-09-17 18:03:54 Нью-Йорк
У брокера: позиций 1, открытых заявок 1.
Капитал $27,576.70; деньги на счёте $26,583.66.
Лимит покупок брокера $54,160.36: может включать заёмные средства, это не бюджет новой сделки.
...
- Generated: `2026-09-17T22:03:54+00:00`
- Market open: `no`
- Orders enabled: `yes`
...
## Positions
- `MSFT` qty `2`, avg `$492.00`, price `$496.52`, value `$993.04`, P/L `$9.04` (`+0.92%`), today `+1.27%`

## Open Orders
- `MSFT` sell stop qty `2`, limit `-`, status `accepted`

## Recent Actions
- `2026-09-17T22:03:09` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-17T22:02:07` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-17T22:01:04` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-17T22:00:02` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-17T21:59:00` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-17T21:57:58` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-17T21:56:56` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-17T21:55:53` `-` `monitor_heartbeat`: details_redacted_use_local_logs
