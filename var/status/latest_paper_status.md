...
Снимок: 2026-09-23 06:26:04 Нью-Йорк
У брокера: позиций 1, открытых заявок 1.
Капитал $27,588.02; деньги на счёте $26,583.66.
Лимит покупок брокера $54,171.68: может включать заёмные средства, это не бюджет новой сделки.
...
- Generated: `2026-09-23T10:26:04+00:00`
- Market open: `no`
- Orders enabled: `yes`
...
## Positions
- `MSFT` qty `2`, avg `$492.00`, price `$502.18`, value `$1004.36`, P/L `$20.36` (`+2.07%`), today `+0.84%`

## Open Orders
- `MSFT` sell stop qty `2`, limit `-`, status `new`

## Recent Actions
- `2026-09-23T10:25:32` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T10:24:30` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T10:23:28` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T10:22:26` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T10:21:23` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T10:20:21` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T10:19:19` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T10:18:17` `-` `monitor_heartbeat`: details_redacted_use_local_logs
