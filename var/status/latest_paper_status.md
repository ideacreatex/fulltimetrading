...
Снимок: 2026-09-18 00:52:12 Нью-Йорк
У брокера: позиций 1, открытых заявок 1.
Капитал $27,577.26; деньги на счёте $26,583.66.
Лимит покупок брокера $54,160.92: может включать заёмные средства, это не бюджет новой сделки.
...
- Generated: `2026-09-18T04:52:12+00:00`
- Market open: `no`
- Orders enabled: `yes`
...
## Positions
- `MSFT` qty `2`, avg `$492.00`, price `$496.80`, value `$993.60`, P/L `$9.60` (`+0.98%`), today `-0.19%`

## Open Orders
- `MSFT` sell stop qty `2`, limit `-`, status `accepted`

## Recent Actions
- `2026-09-18T04:51:58` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-18T04:50:55` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-18T04:49:53` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-18T04:48:51` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-18T04:47:49` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-18T04:46:46` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-18T04:45:44` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-18T04:44:42` `-` `monitor_heartbeat`: details_redacted_use_local_logs
