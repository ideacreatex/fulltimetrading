...
Снимок: 2026-09-22 02:08:58 Нью-Йорк
У брокера: позиций 1, открытых заявок 1.
Капитал $27,591.20; деньги на счёте $26,583.66.
Лимит покупок брокера $54,174.86: может включать заёмные средства, это не бюджет новой сделки.
...
- Generated: `2026-09-22T06:08:58+00:00`
- Market open: `no`
- Orders enabled: `yes`
...
## Positions
- `MSFT` qty `2`, avg `$492.00`, price `$503.77`, value `$1007.54`, P/L `$23.54` (`+2.39%`), today `+0.43%`

## Open Orders
- `MSFT` sell stop qty `2`, limit `-`, status `accepted`

## Recent Actions
- `2026-09-22T06:08:24` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T06:07:22` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T06:06:20` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T06:05:18` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T06:04:15` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T06:03:13` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T06:02:11` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T06:01:09` `-` `monitor_heartbeat`: details_redacted_use_local_logs
