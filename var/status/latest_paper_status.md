...
Снимок: 2026-09-25 09:07:04 Нью-Йорк
У брокера: позиций 1, открытых заявок 1.
Капитал $27,581.92; деньги на счёте $26,583.66.
Лимит покупок брокера $54,165.58: может включать заёмные средства, это не бюджет новой сделки.
...
- Generated: `2026-09-25T13:07:04+00:00`
- Market open: `no`
- Orders enabled: `yes`
...
## Positions
- `MSFT` qty `2`, avg `$492.00`, price `$499.13`, value `$998.26`, P/L `$14.26` (`+1.45%`), today `+0.24%`

## Open Orders
- `MSFT` sell stop qty `2`, limit `-`, status `new`

## Recent Actions
- `2026-09-25T13:06:55` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T13:05:52` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T13:04:50` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T13:03:48` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T13:02:46` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T13:01:43` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T13:00:41` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T12:59:39` `-` `monitor_heartbeat`: details_redacted_use_local_logs
