...
Снимок: 2026-09-23 15:31:02 Нью-Йорк
У брокера: позиций 1, открытых заявок 1.
Капитал $27,584.12; деньги на счёте $26,583.66.
Лимит покупок брокера $54,167.78: может включать заёмные средства, это не бюджет новой сделки.
...
- Generated: `2026-09-23T19:31:02+00:00`
- Market open: `yes`
- Orders enabled: `yes`
...
## Positions
- `MSFT` qty `2`, avg `$492.00`, price `$500.26`, value `$1000.52`, P/L `$16.52` (`+1.68%`), today `+0.45%`

## Open Orders
- `MSFT` sell stop qty `2`, limit `-`, status `new`

## Recent Actions
- `2026-09-23T19:30:22` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T19:29:20` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T19:28:17` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T19:27:15` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T19:26:13` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T19:25:11` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T19:24:08` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T19:23:06` `-` `monitor_heartbeat`: details_redacted_use_local_logs
