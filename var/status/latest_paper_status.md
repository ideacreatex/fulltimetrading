...
Снимок: 2026-09-18 19:46:36 Нью-Йорк
У брокера: позиций 1, открытых заявок 1.
Капитал $27,571.62; деньги на счёте $26,583.66.
Лимит покупок брокера $54,155.28: может включать заёмные средства, это не бюджет новой сделки.
...
- Generated: `2026-09-18T23:46:36+00:00`
- Market open: `no`
- Orders enabled: `yes`
...
## Positions
- `MSFT` qty `2`, avg `$492.00`, price `$493.98`, value `$987.96`, P/L `$3.96` (`+0.40%`), today `-0.76%`

## Open Orders
- `MSFT` sell stop qty `2`, limit `-`, status `new`

## Recent Actions
- `2026-09-18T23:45:45` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-18T23:44:43` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-18T23:43:41` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-18T23:42:38` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-18T23:41:36` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-18T23:40:34` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-18T23:39:32` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-18T23:38:29` `-` `monitor_heartbeat`: details_redacted_use_local_logs
