...
Снимок: 2026-09-24 16:59:06 Нью-Йорк
У брокера: позиций 1, открытых заявок 1.
Капитал $27,579.54; деньги на счёте $26,583.66.
Лимит покупок брокера $54,163.20: может включать заёмные средства, это не бюджет новой сделки.
...
- Generated: `2026-09-24T20:59:06+00:00`
- Market open: `no`
- Orders enabled: `yes`
...
## Positions
- `MSFT` qty `2`, avg `$492.00`, price `$497.94`, value `$995.88`, P/L `$11.88` (`+1.21%`), today `-0.53%`

## Open Orders
- `MSFT` sell stop qty `2`, limit `-`, status `new`

## Recent Actions
- `2026-09-24T20:58:31` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-24T20:57:29` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-24T20:56:27` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-24T20:55:25` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-24T20:54:23` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-24T20:53:21` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-24T20:52:18` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-24T20:51:16` `-` `monitor_heartbeat`: details_redacted_use_local_logs
