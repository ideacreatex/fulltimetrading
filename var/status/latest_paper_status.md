...
Снимок: 2026-09-23 20:48:37 Нью-Йорк
У брокера: позиций 1, открытых заявок 1.
Капитал $27,583.68; деньги на счёте $26,583.66.
Лимит покупок брокера $54,167.34: может включать заёмные средства, это не бюджет новой сделки.
...
- Generated: `2026-09-24T00:48:37+00:00`
- Market open: `no`
- Orders enabled: `yes`
...
## Positions
- `MSFT` qty `2`, avg `$492.00`, price `$500.01`, value `$1000.02`, P/L `$16.02` (`+1.63%`), today `+0.40%`

## Open Orders
- `MSFT` sell stop qty `2`, limit `-`, status `new`

## Recent Actions
- `2026-09-24T00:47:48` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-24T00:46:45` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-24T00:45:43` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-24T00:44:41` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-24T00:43:39` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-24T00:42:37` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-24T00:41:35` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-24T00:40:33` `-` `monitor_heartbeat`: details_redacted_use_local_logs
