...
Снимок: 2026-09-22 11:43:43 Нью-Йорк
У брокера: позиций 1, открытых заявок 1.
Капитал $27,574.14; деньги на счёте $26,583.66.
Лимит покупок брокера $54,157.80: может включать заёмные средства, это не бюджет новой сделки.
...
- Generated: `2026-09-22T15:43:43+00:00`
- Market open: `yes`
- Orders enabled: `yes`
...
## Positions
- `MSFT` qty `2`, avg `$492.00`, price `$495.22`, value `$990.44`, P/L `$6.44` (`+0.65%`), today `-1.27%`

## Open Orders
- `MSFT` sell stop qty `2`, limit `-`, status `new`

## Recent Actions
- `2026-09-22T15:43:13` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T15:42:11` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T15:41:09` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T15:40:07` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T15:39:04` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T15:38:02` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T15:37:00` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T15:35:57` `-` `monitor_heartbeat`: details_redacted_use_local_logs
