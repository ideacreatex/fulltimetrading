...
Снимок: 2026-09-16 10:04:34 Нью-Йорк
У брокера: позиций 1, открытых заявок 1.
Капитал $27,571.35; деньги на счёте $26,583.66.
Лимит покупок брокера $54,155.01: может включать заёмные средства, это не бюджет новой сделки.
...
- Generated: `2026-09-16T14:04:34+00:00`
- Market open: `yes`
- Orders enabled: `yes`
...
## Positions
- `MSFT` qty `2`, avg `$492.00`, price `$493.85`, value `$987.70`, P/L `$3.69` (`+0.38%`), today `-0.66%`

## Open Orders
- `MSFT` sell stop qty `2`, limit `-`, status `new`

## Recent Actions
- `2026-09-16T14:04:18` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-16T14:03:15` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-16T14:02:13` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-16T14:01:10` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-16T14:00:08` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-16T13:59:06` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-16T13:58:04` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-16T13:57:01` `-` `monitor_heartbeat`: details_redacted_use_local_logs
