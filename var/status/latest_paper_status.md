...
Снимок: 2026-09-18 17:30:31 Нью-Йорк
У брокера: позиций 1, открытых заявок 1.
Капитал $27,573.74; деньги на счёте $26,583.66.
Лимит покупок брокера $54,157.40: может включать заёмные средства, это не бюджет новой сделки.
...
- Generated: `2026-09-18T21:30:31+00:00`
- Market open: `no`
- Orders enabled: `yes`
...
## Positions
- `MSFT` qty `2`, avg `$492.00`, price `$495.04`, value `$990.08`, P/L `$6.08` (`+0.62%`), today `-0.54%`

## Open Orders
- `MSFT` sell stop qty `2`, limit `-`, status `new`

## Recent Actions
- `2026-09-18T21:29:56` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-18T21:28:53` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-18T21:27:51` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-18T21:26:49` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-18T21:25:47` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-18T21:24:45` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-18T21:23:42` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-18T21:22:39` `-` `monitor_heartbeat`: details_redacted_use_local_logs
