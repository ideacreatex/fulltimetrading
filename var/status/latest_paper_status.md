...
Снимок: 2026-09-21 09:00:35 Нью-Йорк
У брокера: позиций 1, открытых заявок 1.
Капитал $27,574.70; деньги на счёте $26,583.66.
Лимит покупок брокера $54,158.36: может включать заёмные средства, это не бюджет новой сделки.
...
- Generated: `2026-09-21T13:00:35+00:00`
- Market open: `no`
- Orders enabled: `yes`
...
## Positions
- `MSFT` qty `2`, avg `$492.00`, price `$495.52`, value `$991.04`, P/L `$7.04` (`+0.71%`), today `+0.35%`

## Open Orders
- `MSFT` sell stop qty `2`, limit `-`, status `new`

## Recent Actions
- `2026-09-21T13:00:04` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T12:59:02` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T12:58:00` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T12:56:58` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T12:55:56` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T12:54:53` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T12:53:51` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T12:52:49` `-` `monitor_heartbeat`: details_redacted_use_local_logs
