...
Снимок: 2026-09-21 02:57:36 Нью-Йорк
У брокера: позиций 1, открытых заявок 1.
Капитал $27,572.98; деньги на счёте $26,583.66.
Лимит покупок брокера $54,156.64: может включать заёмные средства, это не бюджет новой сделки.
...
- Generated: `2026-09-21T06:57:36+00:00`
- Market open: `no`
- Orders enabled: `yes`
...
## Positions
- `MSFT` qty `2`, avg `$492.00`, price `$494.66`, value `$989.32`, P/L `$5.32` (`+0.54%`), today `+0.18%`

## Open Orders
- `MSFT` sell stop qty `2`, limit `-`, status `new`

## Recent Actions
- `2026-09-21T06:56:55` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T06:55:53` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T06:54:51` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T06:53:48` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T06:52:46` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T06:51:43` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T06:50:41` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T06:49:39` `-` `monitor_heartbeat`: details_redacted_use_local_logs
