...
Снимок: 2026-09-22 14:30:10 Нью-Йорк
У брокера: позиций 1, открытых заявок 1.
Капитал $27,578.47; деньги на счёте $26,583.66.
Лимит покупок брокера $54,162.13: может включать заёмные средства, это не бюджет новой сделки.
...
- Generated: `2026-09-22T18:30:10+00:00`
- Market open: `yes`
- Orders enabled: `yes`
...
## Positions
- `MSFT` qty `2`, avg `$492.00`, price `$497.40`, value `$994.80`, P/L `$10.80` (`+1.10%`), today `-0.84%`

## Open Orders
- `MSFT` sell stop qty `2`, limit `-`, status `new`

## Recent Actions
- `2026-09-22T18:29:46` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T18:28:43` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T18:27:39` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T18:26:36` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T18:25:34` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T18:24:31` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T18:23:28` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T18:22:25` `-` `monitor_heartbeat`: details_redacted_use_local_logs
