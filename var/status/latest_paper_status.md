...
Снимок: 2026-09-22 11:58:51 Нью-Йорк
У брокера: позиций 1, открытых заявок 1.
Капитал $27,571.51; деньги на счёте $26,583.66.
Лимит покупок брокера $54,155.17: может включать заёмные средства, это не бюджет новой сделки.
...
- Generated: `2026-09-22T15:58:51+00:00`
- Market open: `yes`
- Orders enabled: `yes`
...
## Positions
- `MSFT` qty `2`, avg `$492.00`, price `$493.95`, value `$987.90`, P/L `$3.90` (`+0.40%`), today `-1.53%`

## Open Orders
- `MSFT` sell stop qty `2`, limit `-`, status `new`

## Recent Actions
- `2026-09-22T15:58:47` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T15:57:45` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T15:56:43` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T15:55:41` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T15:54:38` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T15:53:36` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T15:52:34` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T15:51:32` `-` `monitor_heartbeat`: details_redacted_use_local_logs
