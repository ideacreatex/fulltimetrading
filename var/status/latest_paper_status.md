...
Снимок: 2026-09-21 05:28:52 Нью-Йорк
У брокера: позиций 1, открытых заявок 1.
Капитал $27,572.14; деньги на счёте $26,583.66.
Лимит покупок брокера $54,155.80: может включать заёмные средства, это не бюджет новой сделки.
...
- Generated: `2026-09-21T09:28:52+00:00`
- Market open: `no`
- Orders enabled: `yes`
...
## Positions
- `MSFT` qty `2`, avg `$492.00`, price `$494.24`, value `$988.48`, P/L `$4.48` (`+0.46%`), today `+0.09%`

## Open Orders
- `MSFT` sell stop qty `2`, limit `-`, status `new`

## Recent Actions
- `2026-09-21T09:28:30` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T09:27:28` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T09:26:26` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T09:25:23` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T09:24:21` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T09:23:19` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T09:22:17` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-21T09:21:14` `-` `monitor_heartbeat`: details_redacted_use_local_logs
