...
Снимок: 2026-09-23 07:26:34 Нью-Йорк
У брокера: позиций 1, открытых заявок 1.
Капитал $27,587.99; деньги на счёте $26,583.66.
Лимит покупок брокера $54,171.65: может включать заёмные средства, это не бюджет новой сделки.
...
- Generated: `2026-09-23T11:26:34+00:00`
- Market open: `no`
- Orders enabled: `yes`
...
## Positions
- `MSFT` qty `2`, avg `$492.00`, price `$502.16`, value `$1004.33`, P/L `$20.33` (`+2.07%`), today `+0.84%`

## Open Orders
- `MSFT` sell stop qty `2`, limit `-`, status `new`

## Recent Actions
- `2026-09-23T11:25:41` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T11:24:39` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T11:23:37` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T11:22:35` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T11:21:33` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T11:20:30` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T11:19:28` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T11:18:26` `-` `monitor_heartbeat`: details_redacted_use_local_logs
