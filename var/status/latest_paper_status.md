...
Снимок: 2026-09-25 07:51:26 Нью-Йорк
У брокера: позиций 1, открытых заявок 1.
Капитал $27,579.84; деньги на счёте $26,583.66.
Лимит покупок брокера $54,163.50: может включать заёмные средства, это не бюджет новой сделки.
...
- Generated: `2026-09-25T11:51:26+00:00`
- Market open: `no`
- Orders enabled: `yes`
...
## Positions
- `MSFT` qty `2`, avg `$492.00`, price `$498.09`, value `$996.18`, P/L `$12.18` (`+1.24%`), today `+0.03%`

## Open Orders
- `MSFT` sell stop qty `2`, limit `-`, status `new`

## Recent Actions
- `2026-09-25T11:51:08` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T11:50:05` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T11:49:03` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T11:48:01` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T11:46:58` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T11:45:55` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T11:44:53` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T11:43:51` `-` `monitor_heartbeat`: details_redacted_use_local_logs
