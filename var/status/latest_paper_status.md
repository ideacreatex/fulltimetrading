...
Снимок: 2026-09-23 01:20:31 Нью-Йорк
У брокера: позиций 1, открытых заявок 1.
Капитал $27,584.58; деньги на счёте $26,583.66.
Лимит покупок брокера $54,168.24: может включать заёмные средства, это не бюджет новой сделки.
...
- Generated: `2026-09-23T05:20:31+00:00`
- Market open: `no`
- Orders enabled: `yes`
...
## Positions
- `MSFT` qty `2`, avg `$492.00`, price `$500.46`, value `$1000.92`, P/L `$16.92` (`+1.72%`), today `+0.49%`

## Open Orders
- `MSFT` sell stop qty `2`, limit `-`, status `new`

## Recent Actions
- `2026-09-23T05:19:41` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T05:18:38` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T05:17:36` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T05:16:34` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T05:15:32` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T05:14:30` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T05:13:28` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T05:12:25` `-` `monitor_heartbeat`: details_redacted_use_local_logs
