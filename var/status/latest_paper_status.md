...
Снимок: 2026-09-25 00:02:30 Нью-Йорк
У брокера: позиций 1, открытых заявок 1.
Капитал $27,578.20; деньги на счёте $26,583.66.
Лимит покупок брокера $54,161.86: может включать заёмные средства, это не бюджет новой сделки.
...
- Generated: `2026-09-25T04:02:30+00:00`
- Market open: `no`
- Orders enabled: `yes`
...
## Positions
- `MSFT` qty `2`, avg `$492.00`, price `$497.27`, value `$994.54`, P/L `$10.54` (`+1.07%`), today `-0.13%`

## Open Orders
- `MSFT` sell stop qty `2`, limit `-`, status `new`

## Recent Actions
- `2026-09-25T04:02:13` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T04:01:11` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T04:00:09` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T03:59:07` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T03:58:04` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T03:57:02` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T03:56:00` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-25T03:54:58` `-` `monitor_heartbeat`: details_redacted_use_local_logs
