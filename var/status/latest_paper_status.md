...
Снимок: 2026-09-22 05:25:37 Нью-Йорк
У брокера: позиций 1, открытых заявок 1.
Капитал $27,590.74; деньги на счёте $26,583.66.
Лимит покупок брокера $54,174.40: может включать заёмные средства, это не бюджет новой сделки.
...
- Generated: `2026-09-22T09:25:37+00:00`
- Market open: `no`
- Orders enabled: `yes`
...
## Positions
- `MSFT` qty `2`, avg `$492.00`, price `$503.54`, value `$1007.08`, P/L `$23.08` (`+2.35%`), today `+0.39%`

## Open Orders
- `MSFT` sell stop qty `2`, limit `-`, status `new`

## Recent Actions
- `2026-09-22T09:25:31` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T09:24:29` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T09:23:27` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T09:22:24` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T09:21:22` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T09:20:20` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T09:19:18` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-22T09:18:15` `-` `monitor_heartbeat`: details_redacted_use_local_logs
