...
Снимок: 2026-09-17 21:20:29 Нью-Йорк
У брокера: позиций 1, открытых заявок 1.
Капитал $27,577.42; деньги на счёте $26,583.66.
Лимит покупок брокера $54,161.08: может включать заёмные средства, это не бюджет новой сделки.
...
- Generated: `2026-09-18T01:20:29+00:00`
- Market open: `no`
- Orders enabled: `yes`
...
## Positions
- `MSFT` qty `2`, avg `$492.00`, price `$496.88`, value `$993.76`, P/L `$9.76` (`+0.99%`), today `+1.34%`

## Open Orders
- `MSFT` sell stop qty `2`, limit `-`, status `accepted`

## Recent Actions
- `2026-09-18T01:20:17` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-18T01:19:15` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-18T01:18:12` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-18T01:17:10` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-18T01:16:08` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-18T01:15:06` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-18T01:14:04` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-18T01:13:01` `-` `monitor_heartbeat`: details_redacted_use_local_logs
