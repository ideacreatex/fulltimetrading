...
Снимок: 2026-09-23 12:29:21 Нью-Йорк
У брокера: позиций 1, открытых заявок 1.
Капитал $27,581.14; деньги на счёте $26,583.66.
Лимит покупок брокера $54,164.80: может включать заёмные средства, это не бюджет новой сделки.
...
- Generated: `2026-09-23T16:29:21+00:00`
- Market open: `yes`
- Orders enabled: `yes`
...
## Positions
- `MSFT` qty `2`, avg `$492.00`, price `$498.76`, value `$997.53`, P/L `$13.53` (`+1.38%`), today `+0.15%`

## Open Orders
- `MSFT` sell stop qty `2`, limit `-`, status `new`

## Recent Actions
- `2026-09-23T16:28:42` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T16:27:40` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T16:26:38` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T16:25:35` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T16:24:33` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T16:23:31` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T16:22:28` `-` `monitor_heartbeat`: details_redacted_use_local_logs
- `2026-09-23T16:21:26` `-` `monitor_heartbeat`: details_redacted_use_local_logs
