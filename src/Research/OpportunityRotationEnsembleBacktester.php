 ...
 * child remains a shadow-only OpportunityRotationBacktester.
 */
final class OpportunityRotationEnsembleBacktester
{
    /**
     * @var array<string,array{
     *     allocation:float,
     *     backtester:OpportunityRotationBacktester
     * }>
     */
    ...
    public function __construct(
        ...
        foreach ($sleeves as $key => $definition) {
            ...
            $normalized[$name] = [
                ...
                'backtester' => new OpportunityRotationBacktester($config, $indicators),
            ];
