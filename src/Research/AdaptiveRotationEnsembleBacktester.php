 ...
 * child remains a shadow-only AdaptiveRotationBacktester.
 */
final class AdaptiveRotationEnsembleBacktester
{
    /**
     * @var array<string,array{
     *     allocation:float,
     *     backtester:AdaptiveRotationBacktester
     * }>
     */
    ...
    public function __construct(
        ...
        foreach ($sleeves as $key => $definition) {
            ...
            $normalized[$name] = [
                ...
                'backtester' => new AdaptiveRotationBacktester($config, $indicators),
            ];
